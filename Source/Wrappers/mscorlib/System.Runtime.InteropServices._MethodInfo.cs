...
{
    public static class ___MethodInfo
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._MethodInfo> _MethodInfoValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_MethodInfoValue, iTInfo, lcid, ppTInfo,
                (_MethodInfoValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _MethodInfoValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }


        public static IObservable<System.Guid> GetIDsOfNames(
            this IObservable<System.Runtime.InteropServices._MethodInfo> _MethodInfoValue, IObservable<System.Guid> riid,
        ...
        {
            return Observable.Zip(_MethodInfoValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_MethodInfoValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda) =>
                {
                    _MethodInfoValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                        rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_MethodInfoValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,
                pExcepInfo, puArgErr,
                (_MethodInfoValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda, pDispParamsLambda,
                    pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _MethodInfoValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
        ...
        {
            return Observable.Zip(_MethodInfoValue, other,
                (_MethodInfoValueLambda, otherLambda) => _MethodInfoValueLambda.Equals(otherLambda));
        }
        ...
        {
            return Observable.Zip(_MethodInfoValue, attributeType, inherit,
                (_MethodInfoValueLambda, attributeTypeLambda, inheritLambda) =>
                    _MethodInfoValueLambda.GetCustomAttributes(attributeTypeLambda, inheritLambda));
        }
        ...
        {
            return Observable.Zip(_MethodInfoValue, inherit,
                (_MethodInfoValueLambda, inheritLambda) => _MethodInfoValueLambda.GetCustomAttributes(inheritLambda));
        }
            ...
            IObservable<System.Type> attributeType, IObservable<System.Boolean> inherit)
        {
            return Observable.Zip(_MethodInfoValue, attributeType, inherit,
                (_MethodInfoValueLambda, attributeTypeLambda, inheritLambda) =>
                    _MethodInfoValueLambda.IsDefined(attributeTypeLambda, inheritLambda));
        }
        ...
        public static IObservable<System.Reflection.ParameterInfo[]> GetParameters(
            this IObservable<System.Runtime.InteropServices._MethodInfo> _MethodInfoValue)
        {
            return Observable.Select(_MethodInfoValue,
                (_MethodInfoValueLambda) => _MethodInfoValueLambda.GetParameters());
        }
        ...
        {
            return Observable.Select(_MethodInfoValue,
                (_MethodInfoValueLambda) => _MethodInfoValueLambda.GetMethodImplementationFlags());
        }
        ...
        {
            return Observable.Zip(_MethodInfoValue, obj, invokeAttr, binder, parameters, culture,
                (_MethodInfoValueLambda, objLambda, invokeAttrLambda, binderLambda, parametersLambda, cultureLambda) =>
                    _MethodInfoValueLambda.Invoke(objLambda, invokeAttrLambda, binderLambda, parametersLambda,
                        cultureLambda));
        }
        ...
        {
            return Observable.Zip(_MethodInfoValue, obj, parameters,
                (_MethodInfoValueLambda, objLambda, parametersLambda) =>
                    _MethodInfoValueLambda.Invoke(objLambda, parametersLambda));
        }
        ...
        {
            return Observable.Select(_MethodInfoValue,
                (_MethodInfoValueLambda) => _MethodInfoValueLambda.GetBaseDefinition());
        }
        ...
        {
            return Observable.Select(_MethodInfoValue,
                (_MethodInfoValueLambda) => _MethodInfoValueLambda.CallingConvention);
        }
        ...
        {
            return Observable.Select(_MethodInfoValue,
                (_MethodInfoValueLambda) => _MethodInfoValueLambda.IsFamilyAndAssembly);
        }
        ...
        {
            return Observable.Select(_MethodInfoValue,
                (_MethodInfoValueLambda) => _MethodInfoValueLambda.IsFamilyOrAssembly);
        }
        ...
        {
            return Observable.Select(_MethodInfoValue,
                (_MethodInfoValueLambda) => _MethodInfoValueLambda.ReturnTypeCustomAttributes);
        }
    }
}