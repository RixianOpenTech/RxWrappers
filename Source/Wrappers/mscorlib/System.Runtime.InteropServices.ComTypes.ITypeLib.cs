...
namespace System.Runtime.InteropServices.ComTypes
{
    public static class __ITypeLib
    {
        public static IObservable<System.Int32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices.ComTypes.ITypeLib> ITypeLibValue)
        {
        ...
        public static IObservable<Tuple<System.Guid, System.Runtime.InteropServices.ComTypes.ITypeInfo>>
            GetTypeInfoOfGuid(this IObservable<System.Runtime.InteropServices.ComTypes.ITypeLib> ITypeLibValue,
            ...
            IObservable<System.Int32> index)
        {
            return Observable.Zip(ITypeLibValue, index, (ITypeLibValueLambda, indexLambda) =>
            {
                ...
                ITypeLibValueLambda.GetDocumentation(indexLambda, out strNameOutput, out strDocStringOutput,
        ...
        {
            return Observable.Zip(ITypeLibValue, szNameBuf, lHashVal,
                (ITypeLibValueLambda, szNameBufLambda, lHashValLambda) =>
                    ITypeLibValueLambda.IsName(szNameBufLambda, lHashValLambda));
        }
        ...
        {
            return Observable.Zip(ITypeLibValue, szNameBuf, lHashVal, ppTInfo, rgMemId, pcFound,
                (ITypeLibValueLambda, szNameBufLambda, lHashValLambda, ppTInfoLambda, rgMemIdLambda, pcFoundLambda) =>
                {
                    ITypeLibValueLambda.FindName(szNameBufLambda, lHashValLambda, ppTInfoLambda, rgMemIdLambda,
                        ref pcFoundLambda);
        ...
        {
            return ObservableExt.ZipExecute(ITypeLibValue, pTLibAttr,
                (ITypeLibValueLambda, pTLibAttrLambda) => ITypeLibValueLambda.ReleaseTLibAttr(pTLibAttrLambda));
        }
    }
}