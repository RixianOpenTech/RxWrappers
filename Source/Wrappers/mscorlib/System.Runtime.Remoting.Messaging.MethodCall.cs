...
{
    public static class __MethodCall
    {
        public static IObservable<System.Reactive.Unit> RootSetObjectData(
            this IObservable<System.Runtime.Remoting.Messaging.MethodCall> MethodCallValue,
        ...
        {
            return ObservableExt.ZipExecute(MethodCallValue, info, ctx,
                (MethodCallValueLambda, infoLambda, ctxLambda) =>
                    MethodCallValueLambda.RootSetObjectData(infoLambda, ctxLambda));
        }


        public static IObservable<System.Reactive.Unit> ResolveMethod(
            this IObservable<System.Runtime.Remoting.Messaging.MethodCall> MethodCallValue)
        {
            return
                Observable.Do(MethodCallValue, (MethodCallValueLambda) => MethodCallValueLambda.ResolveMethod())
                    .ToUnit();
        }
        ...
        {
            return ObservableExt.ZipExecute(MethodCallValue, info, context,
                (MethodCallValueLambda, infoLambda, contextLambda) =>
                    MethodCallValueLambda.GetObjectData(infoLambda, contextLambda));
        }


        public static IObservable<System.Reactive.Unit> Init(
            this IObservable<System.Runtime.Remoting.Messaging.MethodCall> MethodCallValue)
        {
        ...
        {
            return Observable.Zip(MethodCallValue, argNum,
                (MethodCallValueLambda, argNumLambda) => MethodCallValueLambda.GetArg(argNumLambda));
        }
        ...
        {
            return Observable.Zip(MethodCallValue, index,
                (MethodCallValueLambda, indexLambda) => MethodCallValueLambda.GetArgName(indexLambda));
        }
        ...
        {
            return Observable.Zip(MethodCallValue, argNum,
                (MethodCallValueLambda, argNumLambda) => MethodCallValueLambda.GetInArg(argNumLambda));
        }
        ...
        {
            return Observable.Zip(MethodCallValue, index,
                (MethodCallValueLambda, indexLambda) => MethodCallValueLambda.GetInArgName(indexLambda));
        }
        ...
        {
            return Observable.Zip(MethodCallValue, h,
                (MethodCallValueLambda, hLambda) => MethodCallValueLambda.HeaderHandler(hLambda));
        }
        ...
        public static IObservable<System.Runtime.Remoting.Messaging.LogicalCallContext> get_LogicalCallContext(
            this IObservable<System.Runtime.Remoting.Messaging.MethodCall> MethodCallValue)
        {
            return Observable.Select(MethodCallValue,
                (MethodCallValueLambda) => MethodCallValueLambda.LogicalCallContext);
        }
        ...
        {
            return ObservableExt.ZipExecute(MethodCallValue, value,
                (MethodCallValueLambda, valueLambda) => MethodCallValueLambda.Uri = valueLambda);
        }
    }
}