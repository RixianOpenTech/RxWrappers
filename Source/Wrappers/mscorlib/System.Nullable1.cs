...
namespace System
{
public static class _Nullable1
{
...
public static IObservable<T> GetValueOrDefault<T>(this IObservable<System.Nullable<T>> NullableValue, IObservable<T> defaultValue)
{
...
public static IObservable<System.Boolean> Equals<T>(this IObservable<System.Nullable<T>> NullableValue, IObservable<System.Object> other)
{
...
public static IObservable<T> get_Value<T>(this IObservable<System.Nullable<T>> NullableValue)
{
