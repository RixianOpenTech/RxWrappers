...
{
    public static class __StrongName
    {
        public static IObservable<System.Security.IPermission> CreateIdentityPermission(
            this IObservable<System.Security.Policy.StrongName> StrongNameValue,
            IObservable<System.Security.Policy.Evidence> evidence)
        {
            return Observable.Zip(StrongNameValue, evidence,
                (StrongNameValueLambda, evidenceLambda) =>
                    StrongNameValueLambda.CreateIdentityPermission(evidenceLambda));
        }
        ...
        public static IObservable<System.Boolean> Equals(
            this IObservable<System.Security.Policy.StrongName> StrongNameValue, IObservable<System.Object> o)
        {
            return Observable.Zip(StrongNameValue, o,
                (StrongNameValueLambda, oLambda) => StrongNameValueLambda.Equals(oLambda));
        }
