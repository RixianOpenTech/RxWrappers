    ...
    public static class __HMAC
    {
        ...
        public static IObservable<System.Security.Cryptography.HMAC> Create(IObservable<System.String> algorithmName)
        {
            return Observable.Select(algorithmName,
                (algorithmNameLambda) => System.Security.Cryptography.HMAC.Create(algorithmNameLambda));
        }


        public static IObservable<System.Reactive.Unit> Initialize(
            this IObservable<System.Security.Cryptography.HMAC> HMACValue)
        {
        ...
        public static IObservable<System.Reactive.Unit> set_Key(
            this IObservable<System.Security.Cryptography.HMAC> HMACValue, IObservable<System.Byte[]> value)
        {
            return ObservableExt.ZipExecute(HMACValue, value,
                (HMACValueLambda, valueLambda) => HMACValueLambda.Key = valueLambda);
        }


        public static IObservable<System.Reactive.Unit> set_HashName(
            this IObservable<System.Security.Cryptography.HMAC> HMACValue, IObservable<System.String> value)
        {
            return ObservableExt.ZipExecute(HMACValue, value,
                (HMACValueLambda, valueLambda) => HMACValueLambda.HashName = valueLambda);
        }
    }
}