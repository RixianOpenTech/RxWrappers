...
namespace System
{
    public static class __Single
    {
        ...
        public static IObservable<System.Int32> CompareTo(this IObservable<System.Single> SingleValue,
            IObservable<System.Object> value)
        {
            return Observable.Zip(SingleValue, value,
                (SingleValueLambda, valueLambda) => SingleValueLambda.CompareTo(valueLambda));
        }
        ...
        public static IObservable<System.Boolean> Equals(this IObservable<System.Single> SingleValue,
            IObservable<System.Object> obj)
        {
            return Observable.Zip(SingleValue, obj,
                (SingleValueLambda, objLambda) => SingleValueLambda.Equals(objLambda));
        }


        public static IObservable<System.Boolean> Equals(this IObservable<System.Single> SingleValue,
            IObservable<System.Single> obj)
        {
            return Observable.Zip(SingleValue, obj,
                (SingleValueLambda, objLambda) => SingleValueLambda.Equals(objLambda));
        }
        ...
        {
            return Observable.Zip(SingleValue, provider,
                (SingleValueLambda, providerLambda) => SingleValueLambda.ToString(providerLambda));
        }
        ...
        {
            return Observable.Zip(SingleValue, format,
                (SingleValueLambda, formatLambda) => SingleValueLambda.ToString(formatLambda));
        }
        ...
        {
            return Observable.Zip(SingleValue, format, provider,
                (SingleValueLambda, formatLambda, providerLambda) =>
                    SingleValueLambda.ToString(formatLambda, providerLambda));
        }
            ...
            IObservable<System.Globalization.NumberStyles> style, IObservable<System.IFormatProvider> provider)
        {
            return Observable.Zip(s, style, provider,
                (sLambda, styleLambda, providerLambda) => System.Single.Parse(sLambda, styleLambda, providerLambda));
        }
