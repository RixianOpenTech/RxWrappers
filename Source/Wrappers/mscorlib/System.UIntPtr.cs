...
public static IObservable<System.Void*> ToPointer(this IObservable<System.UIntPtr> UIntPtrValue)
{
    return Observable.Select(UIntPtrValue, (UIntPtrValueLambda) => UIntPtrValueLambda.ToPointer());
}
