    ...
    public static class __HandleRef
    {
        public static IObservable<System.IntPtr> ToIntPtr(IObservable<System.Runtime.InteropServices.HandleRef> value)
        {
            return Observable.Select(value,
                (valueLambda) => System.Runtime.InteropServices.HandleRef.ToIntPtr(valueLambda));
        }


        public static IObservable<System.Object> get_Wrapper(
            this IObservable<System.Runtime.InteropServices.HandleRef> HandleRefValue)
        {
