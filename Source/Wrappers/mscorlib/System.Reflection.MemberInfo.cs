...
{
    public static class __MemberInfo
    {
        public static IObservable<System.Object[]> GetCustomAttributes(
            this IObservable<System.Reflection.MemberInfo> MemberInfoValue, IObservable<System.Boolean> inherit)
        {
            return Observable.Zip(MemberInfoValue, inherit,
                (MemberInfoValueLambda, inheritLambda) => MemberInfoValueLambda.GetCustomAttributes(inheritLambda));
        }


        public static IObservable<System.Object[]> GetCustomAttributes(
            this IObservable<System.Reflection.MemberInfo> MemberInfoValue, IObservable<System.Type> attributeType,
            IObservable<System.Boolean> inherit)
        {
            return Observable.Zip(MemberInfoValue, attributeType, inherit,
                (MemberInfoValueLambda, attributeTypeLambda, inheritLambda) =>
                    MemberInfoValueLambda.GetCustomAttributes(attributeTypeLambda, inheritLambda));
        }
            ...
            IObservable<System.Boolean> inherit)
        {
            return Observable.Zip(MemberInfoValue, attributeType, inherit,
                (MemberInfoValueLambda, attributeTypeLambda, inheritLambda) =>
                    MemberInfoValueLambda.IsDefined(attributeTypeLambda, inheritLambda));
        }


        public static IObservable<System.Collections.Generic.IList<System.Reflection.CustomAttributeData>>
            GetCustomAttributesData(this IObservable<System.Reflection.MemberInfo> MemberInfoValue)
        {
            return Observable.Select(MemberInfoValue,
                (MemberInfoValueLambda) => MemberInfoValueLambda.GetCustomAttributesData());
        }


        public static IObservable<System.Boolean> Equals(this IObservable<System.Reflection.MemberInfo> MemberInfoValue,
            IObservable<System.Object> obj)
        {
            return Observable.Zip(MemberInfoValue, obj,
                (MemberInfoValueLambda, objLambda) => MemberInfoValueLambda.Equals(objLambda));
        }


        public static IObservable<System.Int32> GetHashCode(
            this IObservable<System.Reflection.MemberInfo> MemberInfoValue)
        {
        ...
        public static IObservable<System.Collections.Generic.IEnumerable<System.Reflection.CustomAttributeData>>
            get_CustomAttributes(this IObservable<System.Reflection.MemberInfo> MemberInfoValue)
        {
