...
{
    return Observable.Zip(RawAclValue, index, (RawAclValueLambda, indexLambda) => RawAclValueLambda.Item);
}
...
{
    return ObservableExt.ZipExecute(RawAclValue, index, value, (RawAclValueLambda, indexLambda, valueLambda) => RawAclValueLambda.Item = valueLambda);
}
