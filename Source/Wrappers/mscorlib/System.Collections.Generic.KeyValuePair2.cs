...
namespace System.Collections.Generic
{
    ...
    {
        public static IObservable<System.String> ToString<TKey, TValue>(
            this IObservable<System.Collections.Generic.KeyValuePair<TKey, TValue>> KeyValuePairValue)
        {
            return Observable.Select(KeyValuePairValue, (KeyValuePairValueLambda) => KeyValuePairValueLambda.ToString());
        }


        public static IObservable<TKey> get_Key<TKey, TValue>(
            this IObservable<System.Collections.Generic.KeyValuePair<TKey, TValue>> KeyValuePairValue)
        {
        ...
        public static IObservable<TValue> get_Value<TKey, TValue>(
            this IObservable<System.Collections.Generic.KeyValuePair<TKey, TValue>> KeyValuePairValue)
        {
