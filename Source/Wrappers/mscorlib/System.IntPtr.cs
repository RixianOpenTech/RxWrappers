...
public static IObservable<System.Void*> ToPointer(this IObservable<System.IntPtr> IntPtrValue)
{
    return Observable.Select(IntPtrValue, (IntPtrValueLambda) => IntPtrValueLambda.ToPointer());
}
