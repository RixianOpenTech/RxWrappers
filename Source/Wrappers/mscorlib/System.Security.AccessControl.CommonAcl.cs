...
namespace System.Security.AccessControl
{
    public static class __CommonAcl
    {
        ...
        {
            return Observable.Zip(CommonAclValue, index, (CommonAclValueLambda, indexLambda) => CommonAclValueLambda[indexLambda]);
        }
        ...
        {
            return ObservableExt.ZipExecute(CommonAclValue, index, value, (CommonAclValueLambda, indexLambda, valueLambda) => CommonAclValueLambda[indexLambda] = valueLambda);
        }
