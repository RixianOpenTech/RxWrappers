...
namespace System.Runtime.InteropServices
{
    public static class ___MemberInfo
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._MemberInfo> _MemberInfoValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_MemberInfoValue, iTInfo, lcid, ppTInfo,
                (_MemberInfoValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _MemberInfoValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }


        public static IObservable<System.Guid> GetIDsOfNames(
            this IObservable<System.Runtime.InteropServices._MemberInfo> _MemberInfoValue, IObservable<System.Guid> riid,
        ...
        {
            return Observable.Zip(_MemberInfoValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_MemberInfoValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda) =>
                {
                    _MemberInfoValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                        rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_MemberInfoValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,
                pExcepInfo, puArgErr,
                (_MemberInfoValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda, pDispParamsLambda,
                    pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _MemberInfoValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
        ...
        {
            return Observable.Zip(_MemberInfoValue, other,
                (_MemberInfoValueLambda, otherLambda) => _MemberInfoValueLambda.Equals(otherLambda));
        }
        ...
        {
            return Observable.Zip(_MemberInfoValue, attributeType, inherit,
                (_MemberInfoValueLambda, attributeTypeLambda, inheritLambda) =>
                    _MemberInfoValueLambda.GetCustomAttributes(attributeTypeLambda, inheritLambda));
        }
        ...
        {
            return Observable.Zip(_MemberInfoValue, inherit,
                (_MemberInfoValueLambda, inheritLambda) => _MemberInfoValueLambda.GetCustomAttributes(inheritLambda));
        }
            ...
            IObservable<System.Type> attributeType, IObservable<System.Boolean> inherit)
        {
            return Observable.Zip(_MemberInfoValue, attributeType, inherit,
                (_MemberInfoValueLambda, attributeTypeLambda, inheritLambda) =>
                    _MemberInfoValueLambda.IsDefined(attributeTypeLambda, inheritLambda));
        }
