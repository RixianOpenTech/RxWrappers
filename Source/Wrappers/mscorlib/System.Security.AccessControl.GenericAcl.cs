...
namespace System.Security.AccessControl
{
    public static class __GenericAcl
    {
        public static IObservable<System.Reactive.Unit> GetBinaryForm(
            this IObservable<System.Security.AccessControl.GenericAcl> GenericAclValue,
            IObservable<System.Byte[]> binaryForm, IObservable<System.Int32> offset)
        {
            return ObservableExt.ZipExecute(GenericAclValue, binaryForm, offset,
                (GenericAclValueLambda, binaryFormLambda, offsetLambda) =>
                    GenericAclValueLambda.GetBinaryForm(binaryFormLambda, offsetLambda));
        }


        public static IObservable<System.Reactive.Unit> CopyTo(
            this IObservable<System.Security.AccessControl.GenericAcl> GenericAclValue,
            IObservable<System.Security.AccessControl.GenericAce[]> array, IObservable<System.Int32> index)
        {
            return ObservableExt.ZipExecute(GenericAclValue, array, index,
                (GenericAclValueLambda, arrayLambda, indexLambda) =>
                    GenericAclValueLambda.CopyTo(arrayLambda, indexLambda));
        }


        public static IObservable<System.Security.AccessControl.AceEnumerator> GetEnumerator(
            this IObservable<System.Security.AccessControl.GenericAcl> GenericAclValue)
        {
        ...
        public static IObservable<System.Security.AccessControl.GenericAce> get_Item(
            this IObservable<System.Security.AccessControl.GenericAcl> GenericAclValue, IObservable<System.Int32> index)
        {
            return Observable.Zip(GenericAclValue, index,
                (GenericAclValueLambda, indexLambda) => GenericAclValueLambda[indexLambda]);
        }
        ...
        {
            return ObservableExt.ZipExecute(GenericAclValue, index, value,
                (GenericAclValueLambda, indexLambda, valueLambda) => GenericAclValueLambda[indexLambda] = valueLambda);
        }
    }
}