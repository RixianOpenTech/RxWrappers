...
{
public static class _GenericAcl
{
...
{
    return Observable.Zip(GenericAclValue, index, (GenericAclValueLambda, indexLambda) => GenericAclValueLambda.Item);
}
...
{
    return ObservableExt.ZipExecute(GenericAclValue, index, value, (GenericAclValueLambda, indexLambda, valueLambda) => GenericAclValueLambda.Item = valueLambda);
}
