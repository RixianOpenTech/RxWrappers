...
{
public static class _CustomAttributeExtensions
{
...
{
    return Observable.Select(element, (elementLambda) => System.Reflection.CustomAttributeExtensions.GetCustomAttribute(elementLambda));
}
...
public static IObservable<T> GetCustomAttribute<T>(IObservable<System.Reflection.MemberInfo> element, IObservable<System.Boolean> inherit)
{
    return Observable.Zip(element, inherit, (elementLambda, inheritLambda) => System.Reflection.CustomAttributeExtensions.GetCustomAttribute(elementLambda, inheritLambda));
}


public static IObservable<T> GetCustomAttribute<T>(IObservable<System.Reflection.ParameterInfo> element, IObservable<System.Boolean> inherit)
{
    return Observable.Zip(element, inherit, (elementLambda, inheritLambda) => System.Reflection.CustomAttributeExtensions.GetCustomAttribute(elementLambda, inheritLambda));
}
...
public static IObservable<IEnumerable<T>> GetCustomAttributes<T>(IObservable<System.Reflection.MemberInfo> element)
{
    return Observable.Select(element, (elementLambda) => System.Reflection.CustomAttributeExtensions.GetCustomAttributes(elementLambda));
}


public static IObservable<IEnumerable<T>> GetCustomAttributes<T>(IObservable<System.Reflection.ParameterInfo> element)
{
    return Observable.Select(element, (elementLambda) => System.Reflection.CustomAttributeExtensions.GetCustomAttributes(elementLambda));
}
...
public static IObservable<IEnumerable<T>> GetCustomAttributes<T>(IObservable<System.Reflection.MemberInfo> element, IObservable<System.Boolean> inherit)
{
    return Observable.Zip(element, inherit, (elementLambda, inheritLambda) => System.Reflection.CustomAttributeExtensions.GetCustomAttributes(elementLambda, inheritLambda));
}


public static IObservable<IEnumerable<T>> GetCustomAttributes<T>(IObservable<System.Reflection.ParameterInfo> element, IObservable<System.Boolean> inherit)
{
    return Observable.Zip(element, inherit, (elementLambda, inheritLambda) => System.Reflection.CustomAttributeExtensions.GetCustomAttributes(elementLambda, inheritLambda));
}
