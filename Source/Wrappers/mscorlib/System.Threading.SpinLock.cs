...
{
    public static class __SpinLock
    {
        public static IObservable<System.Boolean> Enter(this IObservable<System.Threading.SpinLock> SpinLockValue,
        ...
        public static IObservable<System.Boolean> TryEnter(this IObservable<System.Threading.SpinLock> SpinLockValue,
            IObservable<System.Boolean> lockTaken)
        {
            return Observable.Zip(SpinLockValue, lockTaken, (SpinLockValueLambda, lockTakenLambda) =>
            {
        ...
        {
            return Observable.Zip(SpinLockValue, timeout, lockTaken,
                (SpinLockValueLambda, timeoutLambda, lockTakenLambda) =>
                {
        ...
        {
            return Observable.Zip(SpinLockValue, millisecondsTimeout, lockTaken,
                (SpinLockValueLambda, millisecondsTimeoutLambda, lockTakenLambda) =>
                {
        ...
        public static IObservable<System.Reactive.Unit> Exit(this IObservable<System.Threading.SpinLock> SpinLockValue,
            IObservable<System.Boolean> useMemoryBarrier)
        {
            return ObservableExt.ZipExecute(SpinLockValue, useMemoryBarrier,
                (SpinLockValueLambda, useMemoryBarrierLambda) => SpinLockValueLambda.Exit(useMemoryBarrierLambda));
        }
        ...
        public static IObservable<System.Boolean> get_IsHeldByCurrentThread(
            this IObservable<System.Threading.SpinLock> SpinLockValue)
        {
            return Observable.Select(SpinLockValue, (SpinLockValueLambda) => SpinLockValueLambda.IsHeldByCurrentThread);
        }


        public static IObservable<System.Boolean> get_IsThreadOwnerTrackingEnabled(
            this IObservable<System.Threading.SpinLock> SpinLockValue)
        {
            return Observable.Select(SpinLockValue,
                (SpinLockValueLambda) => SpinLockValueLambda.IsThreadOwnerTrackingEnabled);
        }
    }
}