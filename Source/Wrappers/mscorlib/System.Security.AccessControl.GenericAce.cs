...
{
    public static class __GenericAce
    {
        public static IObservable<System.Security.AccessControl.GenericAce> CreateFromBinaryForm(
            IObservable<System.Byte[]> binaryForm, IObservable<System.Int32> offset)
        {
            return Observable.Zip(binaryForm, offset,
                (binaryFormLambda, offsetLambda) =>
                    System.Security.AccessControl.GenericAce.CreateFromBinaryForm(binaryFormLambda, offsetLambda));
        }


        public static IObservable<System.Reactive.Unit> GetBinaryForm(
            this IObservable<System.Security.AccessControl.GenericAce> GenericAceValue,
            IObservable<System.Byte[]> binaryForm, IObservable<System.Int32> offset)
        {
            return ObservableExt.ZipExecute(GenericAceValue, binaryForm, offset,
                (GenericAceValueLambda, binaryFormLambda, offsetLambda) =>
                    GenericAceValueLambda.GetBinaryForm(binaryFormLambda, offsetLambda));
        }


        public static IObservable<System.Security.AccessControl.GenericAce> Copy(
            this IObservable<System.Security.AccessControl.GenericAce> GenericAceValue)
        {
        ...
        public static IObservable<System.Boolean> Equals(
            this IObservable<System.Security.AccessControl.GenericAce> GenericAceValue, IObservable<System.Object> o)
        {
            return Observable.Zip(GenericAceValue, o,
                (GenericAceValueLambda, oLambda) => GenericAceValueLambda.Equals(oLambda));
        }
        ...
        public static IObservable<System.Security.AccessControl.AceType> get_AceType(
            this IObservable<System.Security.AccessControl.GenericAce> GenericAceValue)
        {
        ...
        public static IObservable<System.Security.AccessControl.AceFlags> get_AceFlags(
            this IObservable<System.Security.AccessControl.GenericAce> GenericAceValue)
        {
        ...
        public static IObservable<System.Reactive.Unit> set_AceFlags(
            this IObservable<System.Security.AccessControl.GenericAce> GenericAceValue,
            IObservable<System.Security.AccessControl.AceFlags> value)
        {
            return ObservableExt.ZipExecute(GenericAceValue, value,
                (GenericAceValueLambda, valueLambda) => GenericAceValueLambda.AceFlags = valueLambda);
        }
    }
}