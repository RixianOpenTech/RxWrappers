...
{
    public static class __SoapDate
    {
        public static IObservable<System.String> GetXsdType(
            this IObservable<System.Runtime.Remoting.Metadata.W3cXsd2001.SoapDate> SoapDateValue)
        {
        ...
        public static IObservable<System.Runtime.Remoting.Metadata.W3cXsd2001.SoapDate> Parse(
            IObservable<System.String> value)
        {
            return Observable.Select(value,
                (valueLambda) => System.Runtime.Remoting.Metadata.W3cXsd2001.SoapDate.Parse(valueLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(SoapDateValue, value,
                (SoapDateValueLambda, valueLambda) => SoapDateValueLambda.Value = valueLambda);
        }
        ...
        {
            return ObservableExt.ZipExecute(SoapDateValue, value,
                (SoapDateValueLambda, valueLambda) => SoapDateValueLambda.Sign = valueLambda);
        }
    }
}