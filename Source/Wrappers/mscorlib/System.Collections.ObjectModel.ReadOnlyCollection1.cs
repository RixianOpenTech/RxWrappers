...
{
public static class _ReadOnlyCollection1
{
...
{
    return Observable.Zip(ReadOnlyCollectionValue, index, (ReadOnlyCollectionValueLambda, indexLambda) => ReadOnlyCollectionValueLambda.Item);
}
