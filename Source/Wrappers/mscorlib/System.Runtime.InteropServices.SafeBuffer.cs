...
namespace System.Runtime.InteropServices
{
    public static class __SafeBuffer
    {
        ...
        public static IObservable<T> Read<T>(this IObservable<System.Runtime.InteropServices.SafeBuffer> SafeBufferValue, IObservable<System.UInt64> byteOffset) where T : struct 
        {
            return Observable.Zip(SafeBufferValue, byteOffset, (SafeBufferValueLambda, byteOffsetLambda) => SafeBufferValueLambda.Read<T>(byteOffsetLambda));
        }


        public static IObservable<System.Reactive.Unit> ReadArray<T>(this IObservable<System.Runtime.InteropServices.SafeBuffer> SafeBufferValue, IObservable<System.UInt64> byteOffset, IObservable<T[]> array, IObservable<System.Int32> index, IObservable<System.Int32> count) where T : struct
        {
        ...
        public static IObservable<System.Reactive.Unit> Write<T>(this IObservable<System.Runtime.InteropServices.SafeBuffer> SafeBufferValue, IObservable<System.UInt64> byteOffset, IObservable<T> value) where T : struct
        {
        ...
        public static IObservable<System.Reactive.Unit> WriteArray<T>(this IObservable<System.Runtime.InteropServices.SafeBuffer> SafeBufferValue, IObservable<System.UInt64> byteOffset, IObservable<T[]> array, IObservable<System.Int32> index, IObservable<System.Int32> count) where T : struct
        {
