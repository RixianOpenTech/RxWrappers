...
namespace System
{
    ...
    {
        public static IObservable<System.Int32> CompareTo(this IObservable<System.UInt16> UInt16Value,
            IObservable<System.Object> value)
        {
            return Observable.Zip(UInt16Value, value,
                (UInt16ValueLambda, valueLambda) => UInt16ValueLambda.CompareTo(valueLambda));
        }
        ...
        public static IObservable<System.Boolean> Equals(this IObservable<System.UInt16> UInt16Value,
            IObservable<System.Object> obj)
        {
            return Observable.Zip(UInt16Value, obj,
                (UInt16ValueLambda, objLambda) => UInt16ValueLambda.Equals(objLambda));
        }


        public static IObservable<System.Boolean> Equals(this IObservable<System.UInt16> UInt16Value,
            IObservable<System.UInt16> obj)
        {
            return Observable.Zip(UInt16Value, obj,
                (UInt16ValueLambda, objLambda) => UInt16ValueLambda.Equals(objLambda));
        }
        ...
        {
            return Observable.Zip(UInt16Value, provider,
                (UInt16ValueLambda, providerLambda) => UInt16ValueLambda.ToString(providerLambda));
        }
        ...
        {
            return Observable.Zip(UInt16Value, format,
                (UInt16ValueLambda, formatLambda) => UInt16ValueLambda.ToString(formatLambda));
        }
        ...
        {
            return Observable.Zip(UInt16Value, format, provider,
                (UInt16ValueLambda, formatLambda, providerLambda) =>
                    UInt16ValueLambda.ToString(formatLambda, providerLambda));
        }
            ...
            IObservable<System.Globalization.NumberStyles> style, IObservable<System.IFormatProvider> provider)
        {
            return Observable.Zip(s, style, provider,
                (sLambda, styleLambda, providerLambda) => System.UInt16.Parse(sLambda, styleLambda, providerLambda));
        }
