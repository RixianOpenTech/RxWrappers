...
namespace System
{
    public static class __UInt64
    {
        public static IObservable<System.Int32> CompareTo(this IObservable<System.UInt64> UInt64Value,
            IObservable<System.Object> value)
        {
            return Observable.Zip(UInt64Value, value,
                (UInt64ValueLambda, valueLambda) => UInt64ValueLambda.CompareTo(valueLambda));
        }
        ...
        public static IObservable<System.Boolean> Equals(this IObservable<System.UInt64> UInt64Value,
            IObservable<System.Object> obj)
        {
            return Observable.Zip(UInt64Value, obj,
                (UInt64ValueLambda, objLambda) => UInt64ValueLambda.Equals(objLambda));
        }


        public static IObservable<System.Boolean> Equals(this IObservable<System.UInt64> UInt64Value,
            IObservable<System.UInt64> obj)
        {
            return Observable.Zip(UInt64Value, obj,
                (UInt64ValueLambda, objLambda) => UInt64ValueLambda.Equals(objLambda));
        }
        ...
        {
            return Observable.Zip(UInt64Value, provider,
                (UInt64ValueLambda, providerLambda) => UInt64ValueLambda.ToString(providerLambda));
        }
        ...
        {
            return Observable.Zip(UInt64Value, format,
                (UInt64ValueLambda, formatLambda) => UInt64ValueLambda.ToString(formatLambda));
        }
        ...
        {
            return Observable.Zip(UInt64Value, format, provider,
                (UInt64ValueLambda, formatLambda, providerLambda) =>
                    UInt64ValueLambda.ToString(formatLambda, providerLambda));
        }
            ...
            IObservable<System.Globalization.NumberStyles> style, IObservable<System.IFormatProvider> provider)
        {
            return Observable.Zip(s, style, provider,
                (sLambda, styleLambda, providerLambda) => System.UInt64.Parse(sLambda, styleLambda, providerLambda));
        }
