...
namespace System.Runtime.InteropServices
{
    public static class ___EventInfo
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._EventInfo> _EventInfoValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_EventInfoValue, iTInfo, lcid, ppTInfo,
                (_EventInfoValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _EventInfoValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }


        public static IObservable<System.Guid> GetIDsOfNames(
            this IObservable<System.Runtime.InteropServices._EventInfo> _EventInfoValue, IObservable<System.Guid> riid,
        ...
        {
            return Observable.Zip(_EventInfoValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_EventInfoValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda) =>
                {
                    _EventInfoValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                        rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_EventInfoValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo,
                puArgErr,
                (_EventInfoValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda, pDispParamsLambda,
                    pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _EventInfoValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
        ...
        {
            return Observable.Zip(_EventInfoValue, other,
                (_EventInfoValueLambda, otherLambda) => _EventInfoValueLambda.Equals(otherLambda));
        }
        ...
        {
            return Observable.Zip(_EventInfoValue, attributeType, inherit,
                (_EventInfoValueLambda, attributeTypeLambda, inheritLambda) =>
                    _EventInfoValueLambda.GetCustomAttributes(attributeTypeLambda, inheritLambda));
        }
        ...
        {
            return Observable.Zip(_EventInfoValue, inherit,
                (_EventInfoValueLambda, inheritLambda) => _EventInfoValueLambda.GetCustomAttributes(inheritLambda));
        }
            ...
            IObservable<System.Type> attributeType, IObservable<System.Boolean> inherit)
        {
            return Observable.Zip(_EventInfoValue, attributeType, inherit,
                (_EventInfoValueLambda, attributeTypeLambda, inheritLambda) =>
                    _EventInfoValueLambda.IsDefined(attributeTypeLambda, inheritLambda));
        }
        ...
        {
            return Observable.Zip(_EventInfoValue, nonPublic,
                (_EventInfoValueLambda, nonPublicLambda) => _EventInfoValueLambda.GetAddMethod(nonPublicLambda));
        }
        ...
        {
            return Observable.Zip(_EventInfoValue, nonPublic,
                (_EventInfoValueLambda, nonPublicLambda) => _EventInfoValueLambda.GetRemoveMethod(nonPublicLambda));
        }
        ...
        {
            return Observable.Zip(_EventInfoValue, nonPublic,
                (_EventInfoValueLambda, nonPublicLambda) => _EventInfoValueLambda.GetRaiseMethod(nonPublicLambda));
        }
        ...
        public static IObservable<System.Reactive.Unit> AddEventHandler(
            this IObservable<System.Runtime.InteropServices._EventInfo> _EventInfoValue,
            IObservable<System.Object> target, IObservable<System.Delegate> handler)
        {
            return ObservableExt.ZipExecute(_EventInfoValue, target, handler,
                (_EventInfoValueLambda, targetLambda, handlerLambda) =>
                    _EventInfoValueLambda.AddEventHandler(targetLambda, handlerLambda));
        }
            ...
            IObservable<System.Object> target, IObservable<System.Delegate> handler)
        {
            return ObservableExt.ZipExecute(_EventInfoValue, target, handler,
                (_EventInfoValueLambda, targetLambda, handlerLambda) =>
                    _EventInfoValueLambda.RemoveEventHandler(targetLambda, handlerLambda));
        }
