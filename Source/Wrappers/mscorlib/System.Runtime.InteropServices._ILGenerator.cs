...
namespace System.Runtime.InteropServices
{
    public static class ___ILGenerator
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._ILGenerator> _ILGeneratorValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_ILGeneratorValue, iTInfo, lcid, ppTInfo,
                (_ILGeneratorValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _ILGeneratorValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }
        ...
        {
            return Observable.Zip(_ILGeneratorValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_ILGeneratorValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda) =>
                {
                    _ILGeneratorValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                        rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_ILGeneratorValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,
                pExcepInfo, puArgErr,
                (_ILGeneratorValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda, pDispParamsLambda,
                    pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _ILGeneratorValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
