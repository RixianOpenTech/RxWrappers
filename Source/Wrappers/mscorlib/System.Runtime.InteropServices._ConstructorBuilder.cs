...
namespace System.Runtime.InteropServices
{
    public static class ___ConstructorBuilder
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._ConstructorBuilder> _ConstructorBuilderValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_ConstructorBuilderValue, iTInfo, lcid, ppTInfo,
                (_ConstructorBuilderValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _ConstructorBuilderValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }
        ...
        {
            return Observable.Zip(_ConstructorBuilderValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_ConstructorBuilderValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda)
                    =>
                {
                    _ConstructorBuilderValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda,
        ...
        {
            return Observable.Zip(_ConstructorBuilderValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,
                pExcepInfo, puArgErr,
                (_ConstructorBuilderValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda,
                    pDispParamsLambda, pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _ConstructorBuilderValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
                        pDispParamsLambda, pVarResultLambda, pExcepInfoLambda, puArgErrLambda);
                    return riidLambda;
                });
        }
