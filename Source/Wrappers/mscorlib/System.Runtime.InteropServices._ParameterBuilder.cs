...
{
    public static class ___ParameterBuilder
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._ParameterBuilder> _ParameterBuilderValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_ParameterBuilderValue, iTInfo, lcid, ppTInfo,
                (_ParameterBuilderValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _ParameterBuilderValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }
        ...
        {
            return Observable.Zip(_ParameterBuilderValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_ParameterBuilderValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda) =>
                {
                    _ParameterBuilderValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                        rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_ParameterBuilderValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,
                pExcepInfo, puArgErr,
                (_ParameterBuilderValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda,
                    pDispParamsLambda, pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _ParameterBuilderValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
                        pDispParamsLambda, pVarResultLambda, pExcepInfoLambda, puArgErrLambda);
                    return riidLambda;
                });
        }
