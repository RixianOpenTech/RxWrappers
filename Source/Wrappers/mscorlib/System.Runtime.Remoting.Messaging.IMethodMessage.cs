...
{
    public static class __IMethodMessage
    {
        public static IObservable<System.String> GetArgName(
            this IObservable<System.Runtime.Remoting.Messaging.IMethodMessage> IMethodMessageValue,
            IObservable<System.Int32> index)
        {
            return Observable.Zip(IMethodMessageValue, index,
                (IMethodMessageValueLambda, indexLambda) => IMethodMessageValueLambda.GetArgName(indexLambda));
        }
        ...
        {
            return Observable.Zip(IMethodMessageValue, argNum,
                (IMethodMessageValueLambda, argNumLambda) => IMethodMessageValueLambda.GetArg(argNumLambda));
        }
        ...
        public static IObservable<System.String> get_MethodName(
            this IObservable<System.Runtime.Remoting.Messaging.IMethodMessage> IMethodMessageValue)
        {
            return Observable.Select(IMethodMessageValue,
                (IMethodMessageValueLambda) => IMethodMessageValueLambda.MethodName);
        }
        ...
        {
            return Observable.Select(IMethodMessageValue,
                (IMethodMessageValueLambda) => IMethodMessageValueLambda.TypeName);
        }
        ...
        {
            return Observable.Select(IMethodMessageValue,
                (IMethodMessageValueLambda) => IMethodMessageValueLambda.MethodSignature);
        }
        ...
        {
            return Observable.Select(IMethodMessageValue,
                (IMethodMessageValueLambda) => IMethodMessageValueLambda.ArgCount);
        }
        ...
        {
            return Observable.Select(IMethodMessageValue,
                (IMethodMessageValueLambda) => IMethodMessageValueLambda.HasVarArgs);
        }
        ...
        {
            return Observable.Select(IMethodMessageValue,
                (IMethodMessageValueLambda) => IMethodMessageValueLambda.LogicalCallContext);
        }
        ...
        {
            return Observable.Select(IMethodMessageValue,
                (IMethodMessageValueLambda) => IMethodMessageValueLambda.MethodBase);
        }
    }
}