...
namespace System.Security.Policy
{
    public static class __ApplicationTrustCollection
    {
        ...
        {
            return Observable.Zip(ApplicationTrustCollectionValue, index, (ApplicationTrustCollectionValueLambda, indexLambda) => ApplicationTrustCollectionValueLambda[indexLambda]);
        }
        ...
        {
            return Observable.Zip(ApplicationTrustCollectionValue, appFullName, (ApplicationTrustCollectionValueLambda, appFullNameLambda) => ApplicationTrustCollectionValueLambda[appFullNameLambda]);
        }
