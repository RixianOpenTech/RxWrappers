...
namespace System.Reflection.Emit
{
    public static class __StringToken
    {
        public static IObservable<System.Int32> GetHashCode(
            this IObservable<System.Reflection.Emit.StringToken> StringTokenValue)
        {
        ...
        public static IObservable<System.Boolean> Equals(
            this IObservable<System.Reflection.Emit.StringToken> StringTokenValue, IObservable<System.Object> obj)
        {
            return Observable.Zip(StringTokenValue, obj,
                (StringTokenValueLambda, objLambda) => StringTokenValueLambda.Equals(objLambda));
        }


        public static IObservable<System.Boolean> Equals(
            this IObservable<System.Reflection.Emit.StringToken> StringTokenValue,
            IObservable<System.Reflection.Emit.StringToken> obj)
        {
            return Observable.Zip(StringTokenValue, obj,
                (StringTokenValueLambda, objLambda) => StringTokenValueLambda.Equals(objLambda));
        }
