...
namespace System.Collections
{
    public static class __BitArray
    {
        ...
        {
            return Observable.Zip(BitArrayValue, index, (BitArrayValueLambda, indexLambda) => BitArrayValueLambda[indexLambda]);
        }
        ...
        {
            return ObservableExt.ZipExecute(BitArrayValue, index, value, (BitArrayValueLambda, indexLambda, valueLambda) => BitArrayValueLambda[indexLambda] = valueLambda);
        }
