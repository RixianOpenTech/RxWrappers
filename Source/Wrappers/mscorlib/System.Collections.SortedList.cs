...
{
public static class _SortedList
{
...
{
    return Observable.Zip(SortedListValue, key, (SortedListValueLambda, keyLambda) => SortedListValueLambda.Item);
}
...
{
    return ObservableExt.ZipExecute(SortedListValue, key, value, (SortedListValueLambda, keyLambda, valueLambda) => SortedListValueLambda.Item = valueLambda);
}
