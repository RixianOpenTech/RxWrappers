...
{
    public static class __GacMembershipCondition
    {
        ...
        {
            return Observable.Zip(GacMembershipConditionValue, evidence,
                (GacMembershipConditionValueLambda, evidenceLambda) =>
                    GacMembershipConditionValueLambda.Check(evidenceLambda));
        }
        ...
        public static IObservable<System.Security.Policy.IMembershipCondition> Copy(
            this IObservable<System.Security.Policy.GacMembershipCondition> GacMembershipConditionValue)
        {
            return Observable.Select(GacMembershipConditionValue,
                (GacMembershipConditionValueLambda) => GacMembershipConditionValueLambda.Copy());
        }
        ...
        {
            return Observable.Select(GacMembershipConditionValue,
                (GacMembershipConditionValueLambda) => GacMembershipConditionValueLambda.ToXml());
        }
        ...
        {
            return ObservableExt.ZipExecute(GacMembershipConditionValue, e, level,
                (GacMembershipConditionValueLambda, eLambda, levelLambda) =>
                    GacMembershipConditionValueLambda.FromXml(eLambda, levelLambda));
        }
        ...
        {
            return Observable.Select(GacMembershipConditionValue,
                (GacMembershipConditionValueLambda) => GacMembershipConditionValueLambda.GetHashCode());
        }
        ...
        {
            return Observable.Select(GacMembershipConditionValue,
                (GacMembershipConditionValueLambda) => GacMembershipConditionValueLambda.ToString());
        }
    }
}