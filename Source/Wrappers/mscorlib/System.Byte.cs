...
namespace System
{
    ...
    {
        public static IObservable<System.Int32> CompareTo(this IObservable<System.Byte> ByteValue,
            IObservable<System.Object> value)
        {
            return Observable.Zip(ByteValue, value,
                (ByteValueLambda, valueLambda) => ByteValueLambda.CompareTo(valueLambda));
        }
        ...
        public static IObservable<System.Boolean> Equals(this IObservable<System.Byte> ByteValue,
            ...
            IObservable<System.Globalization.NumberStyles> style, IObservable<System.IFormatProvider> provider)
        {
            return Observable.Zip(s, style, provider,
                (sLambda, styleLambda, providerLambda) => System.Byte.Parse(sLambda, styleLambda, providerLambda));
        }
        ...
        {
            return Observable.Zip(ByteValue, format,
                (ByteValueLambda, formatLambda) => ByteValueLambda.ToString(formatLambda));
        }
        ...
        public static IObservable<System.String> ToString(this IObservable<System.Byte> ByteValue,
            IObservable<System.IFormatProvider> provider)
        {
            return Observable.Zip(ByteValue, provider,
                (ByteValueLambda, providerLambda) => ByteValueLambda.ToString(providerLambda));
        }
        ...
        {
            return Observable.Zip(ByteValue, format, provider,
                (ByteValueLambda, formatLambda, providerLambda) =>
                    ByteValueLambda.ToString(formatLambda, providerLambda));
        }
