...
{
public static class _KeyedCollection2
{
...
{
    return Observable.Zip(KeyedCollectionValue, key, (KeyedCollectionValueLambda, keyLambda) => KeyedCollectionValueLambda.Item);
}
