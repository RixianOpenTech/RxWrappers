...
namespace System.Collections.ObjectModel
{
    public static class _ReadOnlyDictionary2
    {
        public static IObservable<IEnumerator<KeyValuePair<TKey, TValue>>> GetEnumerator<TKey, TValue>(
            this IObservable<System.Collections.ObjectModel.ReadOnlyDictionary<TKey, TValue>> ReadOnlyDictionaryValue)
        {
            return Observable.Select(ReadOnlyDictionaryValue,
                (ReadOnlyDictionaryValueLambda) => ReadOnlyDictionaryValueLambda.GetEnumerator());
        }
        ...
        {
            return Observable.Zip(ReadOnlyDictionaryValue, key,
                (ReadOnlyDictionaryValueLambda, keyLambda) => ReadOnlyDictionaryValueLambda.ContainsKey(keyLambda));
        }
