...
namespace System.Runtime.InteropServices.ComTypes
{
    public static class __ITypeLib2
    {
        public static IObservable<System.Int32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices.ComTypes.ITypeLib2> ITypeLib2Value)
        {
            return Observable.Select(ITypeLib2Value, (ITypeLib2ValueLambda) => ITypeLib2ValueLambda.GetTypeInfoCount());
        }


        public static IObservable<System.Runtime.InteropServices.ComTypes.ITypeInfo> GetTypeInfo(
            this IObservable<System.Runtime.InteropServices.ComTypes.ITypeLib2> ITypeLib2Value,
        ...
        public static IObservable<System.Runtime.InteropServices.ComTypes.TYPEKIND> GetTypeInfoType(
            this IObservable<System.Runtime.InteropServices.ComTypes.ITypeLib2> ITypeLib2Value,
            IObservable<System.Int32> index)
        {
            return Observable.Zip(ITypeLib2Value, index, (ITypeLib2ValueLambda, indexLambda) =>
            {
                System.Runtime.InteropServices.ComTypes.TYPEKIND pTKindOutput =
        ...
        public static IObservable<Tuple<System.Guid, System.Runtime.InteropServices.ComTypes.ITypeInfo>>
            GetTypeInfoOfGuid(this IObservable<System.Runtime.InteropServices.ComTypes.ITypeLib2> ITypeLib2Value,
                IObservable<System.Guid> guid)
        {
            return Observable.Zip(ITypeLib2Value, guid, (ITypeLib2ValueLambda, guidLambda) =>
            {
                System.Runtime.InteropServices.ComTypes.ITypeInfo ppTInfoOutput =
                    default(System.Runtime.InteropServices.ComTypes.ITypeInfo);
            ...
            IObservable<System.Int32> index)
        {
            return Observable.Zip(ITypeLib2Value, index, (ITypeLib2ValueLambda, indexLambda) =>
            {
                ...
                ITypeLib2ValueLambda.GetDocumentation(indexLambda, out strNameOutput, out strDocStringOutput,
        ...
        {
            return Observable.Zip(ITypeLib2Value, szNameBuf, lHashVal,
                (ITypeLib2ValueLambda, szNameBufLambda, lHashValLambda) =>
                    ITypeLib2ValueLambda.IsName(szNameBufLambda, lHashValLambda));
        }
        ...
        public static IObservable<short> FindName(
            this IObservable<System.Runtime.InteropServices.ComTypes.ITypeLib2> ITypeLib2Value,
            IObservable<System.String> szNameBuf, IObservable<System.Int32> lHashVal,
            IObservable<System.Runtime.InteropServices.ComTypes.ITypeInfo[]> ppTInfo,
            IObservable<System.Int32[]> rgMemId, IObservable<System.Int16> pcFound)
        {
            return Observable.Zip(ITypeLib2Value, szNameBuf, lHashVal, ppTInfo, rgMemId, pcFound,
                (ITypeLib2ValueLambda, szNameBufLambda, lHashValLambda, ppTInfoLambda, rgMemIdLambda, pcFoundLambda) =>
                {
                    ITypeLib2ValueLambda.FindName(szNameBufLambda, lHashValLambda, ppTInfoLambda, rgMemIdLambda,
                        ref pcFoundLambda);
        ...
        {
            return ObservableExt.ZipExecute(ITypeLib2Value, pTLibAttr,
                (ITypeLib2ValueLambda, pTLibAttrLambda) => ITypeLib2ValueLambda.ReleaseTLibAttr(pTLibAttrLambda));
        }
            ...
            IObservable<System.Int32> index)
        {
            return Observable.Zip(ITypeLib2Value, index, (ITypeLib2ValueLambda, indexLambda) =>
            {
                ...
                ITypeLib2ValueLambda.GetDocumentation2(indexLambda, out pbstrHelpStringOutput,
        ...
        public static IObservable<System.Int32> GetLibStatistics(
            this IObservable<System.Runtime.InteropServices.ComTypes.ITypeLib2> ITypeLib2Value,
            IObservable<System.IntPtr> pcUniqueNames)
        {
        ...
        {
            return ObservableExt.ZipExecute(ITypeLib2Value, pCustData,
                (ITypeLib2ValueLambda, pCustDataLambda) => ITypeLib2ValueLambda.GetAllCustData(pCustDataLambda));
        }
    }
}