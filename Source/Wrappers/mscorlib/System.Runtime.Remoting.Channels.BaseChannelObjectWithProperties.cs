...
{
public static class _BaseChannelObjectWithProperties
{
...
{
    return Observable.Zip(BaseChannelObjectWithPropertiesValue, key, (BaseChannelObjectWithPropertiesValueLambda, keyLambda) => BaseChannelObjectWithPropertiesValueLambda.Item);
}
...
{
    return ObservableExt.ZipExecute(BaseChannelObjectWithPropertiesValue, key, value, (BaseChannelObjectWithPropertiesValueLambda, keyLambda, valueLambda) => BaseChannelObjectWithPropertiesValueLambda.Item = valueLambda);
}
