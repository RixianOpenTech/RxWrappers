...
namespace System.Collections
{
    public static class __ArrayList
    {
        ...
        {
            return Observable.Zip(ArrayListValue, index, (ArrayListValueLambda, indexLambda) => ArrayListValueLambda[indexLambda]);
        }
        ...
        {
            return ObservableExt.ZipExecute(ArrayListValue, index, value, (ArrayListValueLambda, indexLambda, valueLambda) => ArrayListValueLambda[indexLambda] = valueLambda);
        }
