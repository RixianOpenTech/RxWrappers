...
namespace System.Runtime.InteropServices.ComTypes
{
    public static class __IPersistFile
    {
        public static IObservable<System.Guid> GetClassID(
            this IObservable<System.Runtime.InteropServices.ComTypes.IPersistFile> IPersistFileValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(IPersistFileValue, pszFileName, dwMode,
                (IPersistFileValueLambda, pszFileNameLambda, dwModeLambda) =>
                    IPersistFileValueLambda.Load(pszFileNameLambda, dwModeLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(IPersistFileValue, pszFileName, fRemember,
                (IPersistFileValueLambda, pszFileNameLambda, fRememberLambda) =>
                    IPersistFileValueLambda.Save(pszFileNameLambda, fRememberLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(IPersistFileValue, pszFileName,
                (IPersistFileValueLambda, pszFileNameLambda) => IPersistFileValueLambda.SaveCompleted(pszFileNameLambda));
        }
