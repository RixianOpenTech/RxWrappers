...
public static IObservable<System.Boolean> UnsafeQueueNativeOverlapped(IObservable<System.Threading.NativeOverlapped*> overlapped)
{
    return Observable.Select(overlapped, (overlappedLambda) => System.Threading.ThreadPool.UnsafeQueueNativeOverlapped(overlappedLambda));
}
