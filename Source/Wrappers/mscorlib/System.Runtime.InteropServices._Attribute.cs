...
namespace System.Runtime.InteropServices
{
    public static class ___Attribute
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._Attribute> _AttributeValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_AttributeValue, iTInfo, lcid, ppTInfo,
                (_AttributeValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _AttributeValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }


        public static IObservable<System.Guid> GetIDsOfNames(
            this IObservable<System.Runtime.InteropServices._Attribute> _AttributeValue, IObservable<System.Guid> riid,
        ...
        {
            return Observable.Zip(_AttributeValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_AttributeValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda) =>
                {
                    _AttributeValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                        rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_AttributeValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult, pExcepInfo,
                puArgErr,
                (_AttributeValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda, pDispParamsLambda,
                    pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _AttributeValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
