...
{
public static class _Hashtable
{
...
{
    return Observable.Zip(HashtableValue, key, (HashtableValueLambda, keyLambda) => HashtableValueLambda.Item);
}
...
{
    return ObservableExt.ZipExecute(HashtableValue, key, value, (HashtableValueLambda, keyLambda, valueLambda) => HashtableValueLambda.Item = valueLambda);
}
