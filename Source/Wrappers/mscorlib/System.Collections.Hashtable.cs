...
namespace System.Collections
{
    public static class __Hashtable
    {
        public static IObservable<System.Reactive.Unit> Add(
            this IObservable<System.Collections.Hashtable> HashtableValue, IObservable<System.Object> key,
            IObservable<System.Object> value)
        {
            return ObservableExt.ZipExecute(HashtableValue, key, value,
                (HashtableValueLambda, keyLambda, valueLambda) => HashtableValueLambda.Add(keyLambda, valueLambda));
        }


        public static IObservable<System.Reactive.Unit> Clear(
            this IObservable<System.Collections.Hashtable> HashtableValue)
        {
        ...
        public static IObservable<System.Boolean> Contains(
            this IObservable<System.Collections.Hashtable> HashtableValue, IObservable<System.Object> key)
        {
            return Observable.Zip(HashtableValue, key,
                (HashtableValueLambda, keyLambda) => HashtableValueLambda.Contains(keyLambda));
        }
        ...
        {
            return Observable.Zip(HashtableValue, key,
                (HashtableValueLambda, keyLambda) => HashtableValueLambda.ContainsKey(keyLambda));
        }


        public static IObservable<System.Boolean> ContainsValue(
            this IObservable<System.Collections.Hashtable> HashtableValue, IObservable<System.Object> value)
        {
            return Observable.Zip(HashtableValue, value,
                (HashtableValueLambda, valueLambda) => HashtableValueLambda.ContainsValue(valueLambda));
        }


        public static IObservable<System.Reactive.Unit> CopyTo(
            this IObservable<System.Collections.Hashtable> HashtableValue, IObservable<System.Array> array,
            IObservable<System.Int32> arrayIndex)
        {
            return ObservableExt.ZipExecute(HashtableValue, array, arrayIndex,
                (HashtableValueLambda, arrayLambda, arrayIndexLambda) =>
                    HashtableValueLambda.CopyTo(arrayLambda, arrayIndexLambda));
        }
        ...
        public static IObservable<System.Reactive.Unit> Remove(
            this IObservable<System.Collections.Hashtable> HashtableValue, IObservable<System.Object> key)
        {
            return ObservableExt.ZipExecute(HashtableValue, key,
                (HashtableValueLambda, keyLambda) => HashtableValueLambda.Remove(keyLambda));
        }


        public static IObservable<System.Collections.Hashtable> Synchronized(
            IObservable<System.Collections.Hashtable> table)
        {
        ...
        {
            return ObservableExt.ZipExecute(HashtableValue, info, context,
                (HashtableValueLambda, infoLambda, contextLambda) =>
                    HashtableValueLambda.GetObjectData(infoLambda, contextLambda));
        }


        public static IObservable<System.Reactive.Unit> OnDeserialization(
            this IObservable<System.Collections.Hashtable> HashtableValue, IObservable<System.Object> sender)
        {
            return ObservableExt.ZipExecute(HashtableValue, sender,
                (HashtableValueLambda, senderLambda) => HashtableValueLambda.OnDeserialization(senderLambda));
        }


        public static IObservable<System.Object> get_Item(this IObservable<System.Collections.Hashtable> HashtableValue,
            IObservable<System.Object> key)
        {
            return Observable.Zip(HashtableValue, key,
                (HashtableValueLambda, keyLambda) => HashtableValueLambda[keyLambda]);
        }
        ...
        {
            return ObservableExt.ZipExecute(HashtableValue, key, value,
                (HashtableValueLambda, keyLambda, valueLambda) => HashtableValueLambda[keyLambda] = valueLambda);
        }
    }
}