...
{
    public static class __SoapIdref
    {
        public static IObservable<System.String> GetXsdType(
            this IObservable<System.Runtime.Remoting.Metadata.W3cXsd2001.SoapIdref> SoapIdrefValue)
        {
        ...
        public static IObservable<System.Runtime.Remoting.Metadata.W3cXsd2001.SoapIdref> Parse(
            IObservable<System.String> value)
        {
            return Observable.Select(value,
                (valueLambda) => System.Runtime.Remoting.Metadata.W3cXsd2001.SoapIdref.Parse(valueLambda));
        }
        ...
        public static IObservable<System.Reactive.Unit> set_Value(
            ...
            IObservable<System.String> value)
        {
            return ObservableExt.ZipExecute(SoapIdrefValue, value,
                (SoapIdrefValueLambda, valueLambda) => SoapIdrefValueLambda.Value = valueLambda);
        }
    }
}