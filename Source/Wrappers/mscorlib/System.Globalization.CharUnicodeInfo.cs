...
{
public static class _CharUnicodeInfo
{
...
{
    return Observable.Zip(s, index, (sLambda, indexLambda) => System.Globalization.CharUnicodeInfo.GetNumericValue(sLambda, indexLambda));
}


public static IObservable<System.Int32> GetDecimalDigitValue(IObservable<System.Char> ch)
{
    return Observable.Select(ch, (chLambda) => System.Globalization.CharUnicodeInfo.GetDecimalDigitValue(chLambda));
}


public static IObservable<System.Int32> GetDecimalDigitValue(IObservable<System.String> s, IObservable<System.Int32> index)
{
    return Observable.Zip(s, index, (sLambda, indexLambda) => System.Globalization.CharUnicodeInfo.GetDecimalDigitValue(sLambda, indexLambda));
}
...
public static IObservable<System.Int32> GetDigitValue(IObservable<System.String> s, IObservable<System.Int32> index)
{
    return Observable.Zip(s, index, (sLambda, indexLambda) => System.Globalization.CharUnicodeInfo.GetDigitValue(sLambda, indexLambda));
}
...
{
    return Observable.Zip(s, index, (sLambda, indexLambda) => System.Globalization.CharUnicodeInfo.GetUnicodeCategory(sLambda, indexLambda));
}
