...
namespace System.Security.Permissions
{
    public static class __UIPermission
    {
        public static IObservable<System.Boolean> IsUnrestricted(
            this IObservable<System.Security.Permissions.UIPermission> UIPermissionValue)
        {
            return Observable.Select(UIPermissionValue,
                (UIPermissionValueLambda) => UIPermissionValueLambda.IsUnrestricted());
        }
        ...
        {
            return Observable.Zip(UIPermissionValue, target,
                (UIPermissionValueLambda, targetLambda) => UIPermissionValueLambda.IsSubsetOf(targetLambda));
        }
        ...
        {
            return Observable.Zip(UIPermissionValue, target,
                (UIPermissionValueLambda, targetLambda) => UIPermissionValueLambda.Intersect(targetLambda));
        }
        ...
        {
            return Observable.Zip(UIPermissionValue, target,
                (UIPermissionValueLambda, targetLambda) => UIPermissionValueLambda.Union(targetLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(UIPermissionValue, esd,
                (UIPermissionValueLambda, esdLambda) => UIPermissionValueLambda.FromXml(esdLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(UIPermissionValue, value,
                (UIPermissionValueLambda, valueLambda) => UIPermissionValueLambda.Window = valueLambda);
        }
        ...
        {
            return ObservableExt.ZipExecute(UIPermissionValue, value,
                (UIPermissionValueLambda, valueLambda) => UIPermissionValueLambda.Clipboard = valueLambda);
        }
    }
}