...
namespace System.Reflection
{
    public static class __ParameterModifier
    {
        ...
        {
            return Observable.Zip(ParameterModifierValue, index, (ParameterModifierValueLambda, indexLambda) => ParameterModifierValueLambda[indexLambda]);
        }
        ...
        {
            return ObservableExt.ZipExecute(ParameterModifierValue, index, value, (ParameterModifierValueLambda, indexLambda, valueLambda) => ParameterModifierValueLambda[indexLambda] = valueLambda);
        }
