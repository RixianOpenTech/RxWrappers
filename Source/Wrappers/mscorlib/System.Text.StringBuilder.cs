...
namespace System.Text
{
    public static class __StringBuilder
    {
        ...
        {
            return Observable.Zip(StringBuilderValue, index, (StringBuilderValueLambda, indexLambda) => StringBuilderValueLambda[indexLambda]);
        }
        ...
        {
            return ObservableExt.ZipExecute(StringBuilderValue, index, value, (StringBuilderValueLambda, indexLambda, valueLambda) => StringBuilderValueLambda[indexLambda] = valueLambda);
        }
