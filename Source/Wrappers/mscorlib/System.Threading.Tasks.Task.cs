...
namespace System.Threading.Tasks
{
    public static class __Task
    {
        ...
        {
            return ObservableExt.ZipExecute(TaskValue, scheduler,
                (TaskValueLambda, schedulerLambda) => TaskValueLambda.Start(schedulerLambda));
        }


        public static IObservable<System.Reactive.Unit> RunSynchronously(
            this IObservable<System.Threading.Tasks.Task> TaskValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(TaskValue, scheduler,
                (TaskValueLambda, schedulerLambda) => TaskValueLambda.RunSynchronously(schedulerLambda));
        }
        ...
        public static IObservable<System.Runtime.CompilerServices.TaskAwaiter> GetAwaiter(
            this IObservable<System.Threading.Tasks.Task> TaskValue)
        {
        ...
        public static IObservable<System.Runtime.CompilerServices.ConfiguredTaskAwaitable> ConfigureAwait(
            this IObservable<System.Threading.Tasks.Task> TaskValue,
        ...
        public static IObservable<System.Boolean> Wait(this IObservable<System.Threading.Tasks.Task> TaskValue,
            IObservable<System.TimeSpan> timeout)
        {
            return Observable.Zip(TaskValue, timeout,
                (TaskValueLambda, timeoutLambda) => TaskValueLambda.Wait(timeoutLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(TaskValue, cancellationToken,
                (TaskValueLambda, cancellationTokenLambda) => TaskValueLambda.Wait(cancellationTokenLambda));
        }
        ...
        {
            return Observable.Zip(TaskValue, millisecondsTimeout,
                (TaskValueLambda, millisecondsTimeoutLambda) => TaskValueLambda.Wait(millisecondsTimeoutLambda));
        }
        ...
        public static IObservable<System.Boolean> Wait(this IObservable<System.Threading.Tasks.Task> TaskValue,
            ...
            IObservable<System.Threading.CancellationToken> cancellationToken)
        {
            return Observable.Zip(TaskValue, millisecondsTimeout, cancellationToken,
                (TaskValueLambda, millisecondsTimeoutLambda, cancellationTokenLambda) =>
                    TaskValueLambda.Wait(millisecondsTimeoutLambda, cancellationTokenLambda));
        }


        public static IObservable<System.Reactive.Unit> ContinueWith(
            this IObservable<System.Threading.Tasks.Task> TaskValue,
        ...
        public static IObservable<System.Reactive.Unit> ContinueWith(
            this IObservable<System.Threading.Tasks.Task> TaskValue,
            IObservable<System.Action<System.Threading.Tasks.Task, System.Object>> continuationAction,
        ...
        public static IObservable<TResult> ContinueWith<TResult>(
            this IObservable<System.Threading.Tasks.Task> TaskValue,
        ...
        public static IObservable<TResult> ContinueWith<TResult>(
            this IObservable<System.Threading.Tasks.Task> TaskValue,
            IObservable<Func<System.Threading.Tasks.Task, System.Object, TResult>> continuationFunction,
            IObservable<System.Object> state)
        {
            return
        ...
        public static IObservable<System.Boolean> WaitAll(IObservable<System.Threading.Tasks.Task[]> tasks,
            IObservable<System.TimeSpan> timeout)
        {
            return Observable.Zip(tasks, timeout,
                (tasksLambda, timeoutLambda) => System.Threading.Tasks.Task.WaitAll(tasksLambda, timeoutLambda));
        }
        ...
        public static IObservable<System.Boolean> WaitAll(IObservable<System.Threading.Tasks.Task[]> tasks,
            IObservable<System.Int32> millisecondsTimeout)
        {
            return Observable.Zip(tasks, millisecondsTimeout,
                (tasksLambda, millisecondsTimeoutLambda) =>
                    System.Threading.Tasks.Task.WaitAll(tasksLambda, millisecondsTimeoutLambda));
        }
        ...
        public static IObservable<System.Reactive.Unit> WaitAll(IObservable<System.Threading.Tasks.Task[]> tasks,
            IObservable<System.Threading.CancellationToken> cancellationToken)
        {
            return ObservableExt.ZipExecute(tasks, cancellationToken,
                (tasksLambda, cancellationTokenLambda) =>
                    System.Threading.Tasks.Task.WaitAll(tasksLambda, cancellationTokenLambda));
        }
        ...
        public static IObservable<System.Boolean> WaitAll(IObservable<System.Threading.Tasks.Task[]> tasks,
            ...
            IObservable<System.Threading.CancellationToken> cancellationToken)
        {
            return Observable.Zip(tasks, millisecondsTimeout, cancellationToken,
                (tasksLambda, millisecondsTimeoutLambda, cancellationTokenLambda) =>
                    System.Threading.Tasks.Task.WaitAll(tasksLambda, millisecondsTimeoutLambda, cancellationTokenLambda));
        }
        ...
        {
            return Observable.Zip(tasks, timeout,
                (tasksLambda, timeoutLambda) => System.Threading.Tasks.Task.WaitAny(tasksLambda, timeoutLambda));
        }
        ...
        public static IObservable<System.Int32> WaitAny(IObservable<System.Threading.Tasks.Task[]> tasks,
            IObservable<System.Threading.CancellationToken> cancellationToken)
        {
            return Observable.Zip(tasks, cancellationToken,
                (tasksLambda, cancellationTokenLambda) =>
                    System.Threading.Tasks.Task.WaitAny(tasksLambda, cancellationTokenLambda));
        }
            ...
            IObservable<System.Int32> millisecondsTimeout)
        {
            return Observable.Zip(tasks, millisecondsTimeout,
                (tasksLambda, millisecondsTimeoutLambda) =>
                    System.Threading.Tasks.Task.WaitAny(tasksLambda, millisecondsTimeoutLambda));
        }
            ...
            IObservable<System.Threading.CancellationToken> cancellationToken)
        {
            return Observable.Zip(tasks, millisecondsTimeout, cancellationToken,
                (tasksLambda, millisecondsTimeoutLambda, cancellationTokenLambda) =>
                    System.Threading.Tasks.Task.WaitAny(tasksLambda, millisecondsTimeoutLambda, cancellationTokenLambda));
        }
        ...
        {
            return
                Observable.Select(result,
                    (resultLambda) => System.Threading.Tasks.Task.FromResult(resultLambda).ToObservable()).Flatten();
        }
        ...
        {
            return
                Observable.Select(exception,
                    (exceptionLambda) => System.Threading.Tasks.Task.FromException(exceptionLambda).ToObservable())
                    .Flatten();
        }
        ...
        public static IObservable<TResult> FromException<TResult>(IObservable<System.Exception> exception)
        {
            return
                Observable.Select(exception,
                    (exceptionLambda) =>
                        System.Threading.Tasks.Task.FromException<TResult>(exceptionLambda).ToObservable()).Flatten();
        }


        public static IObservable<System.Reactive.Unit> FromCanceled(
            IObservable<System.Threading.CancellationToken> cancellationToken)
        {
            return
                Observable.Select(cancellationToken,
                    (cancellationTokenLambda) =>
                        System.Threading.Tasks.Task.FromCanceled(cancellationTokenLambda).ToObservable()).Flatten();
        }


        public static IObservable<TResult> FromCanceled<TResult>(
            IObservable<System.Threading.CancellationToken> cancellationToken)
        {
            return
                Observable.Select(cancellationToken,
                    (cancellationTokenLambda) =>
                        System.Threading.Tasks.Task.FromCanceled<TResult>(cancellationTokenLambda).ToObservable())
                    .Flatten();
        }
        ...
        {
            return
                Observable.Select(action, (actionLambda) => System.Threading.Tasks.Task.Run(actionLambda).ToObservable())
                    .Flatten();
        }
        ...
        {
            return
                Observable.Zip(action, cancellationToken,
                    (actionLambda, cancellationTokenLambda) =>
                        System.Threading.Tasks.Task.Run(actionLambda, cancellationTokenLambda).ToObservable()).Flatten();
        }
        ...
        {
            return
                Observable.Select(function,
                    (functionLambda) => System.Threading.Tasks.Task.Run(functionLambda).ToObservable()).Flatten();
        }
        ...
        {
            return
                Observable.Zip(function, cancellationToken,
                    (functionLambda, cancellationTokenLambda) =>
                        System.Threading.Tasks.Task.Run(functionLambda, cancellationTokenLambda).ToObservable())
                    .Flatten();
        }


        public static IObservable<System.Reactive.Unit> Run(
            IObservable<System.Func<System.Threading.Tasks.Task>> function)
        {
            return
                Observable.Select(function,
                    (functionLambda) => System.Threading.Tasks.Task.Run(functionLambda).ToObservable()).Flatten();
        ...
        {
            return
                Observable.Select(delay, (delayLambda) => System.Threading.Tasks.Task.Delay(delayLambda).ToObservable())
                    .Flatten();
        }
        ...
        {
            return
                Observable.Zip(delay, cancellationToken,
                    (delayLambda, cancellationTokenLambda) =>
                        System.Threading.Tasks.Task.Delay(delayLambda, cancellationTokenLambda).ToObservable())
                    .Flatten();
        }
        ...
        {
            return
                Observable.Select(millisecondsDelay,
                    (millisecondsDelayLambda) =>
                        System.Threading.Tasks.Task.Delay(millisecondsDelayLambda).ToObservable()).Flatten();
        }
        ...
        {
            return
                Observable.Zip(millisecondsDelay, cancellationToken,
                    (millisecondsDelayLambda, cancellationTokenLambda) =>
                        System.Threading.Tasks.Task.Delay(millisecondsDelayLambda, cancellationTokenLambda)
                            .ToObservable()).Flatten();
        }


        public static IObservable<System.Reactive.Unit> WhenAll(
            IObservable<System.Collections.Generic.IEnumerable<System.Threading.Tasks.Task>> tasks)
        {
            return
                Observable.Select(tasks,
                    (tasksLambda) => System.Threading.Tasks.Task.WhenAll(tasksLambda).ToObservable()).Flatten();
        }
        ...
        public static IObservable<System.Threading.Tasks.Task> WhenAny(IObservable<System.Threading.Tasks.Task[]> tasks)
        {
            return
                Observable.Select(tasks,
                    (tasksLambda) => System.Threading.Tasks.Task.WhenAny(tasksLambda).ToObservable()).Flatten();
        }


        public static IObservable<System.Threading.Tasks.Task> WhenAny(
            IObservable<System.Collections.Generic.IEnumerable<System.Threading.Tasks.Task>> tasks)
        {
            return
                Observable.Select(tasks,
        ...
        public static IObservable<System.AggregateException> get_Exception(
            this IObservable<System.Threading.Tasks.Task> TaskValue)
        {
        ...
        public static IObservable<System.Threading.Tasks.TaskStatus> get_Status(
            this IObservable<System.Threading.Tasks.Task> TaskValue)
        {
