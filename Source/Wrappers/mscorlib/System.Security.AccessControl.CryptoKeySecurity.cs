...
namespace System.Security.AccessControl
{
    public static class __CryptoKeySecurity
    {
        public static IObservable<System.Security.AccessControl.AccessRule> AccessRuleFactory(
            this IObservable<System.Security.AccessControl.CryptoKeySecurity> CryptoKeySecurityValue,
            ...
            IObservable<System.Security.AccessControl.AccessControlType> type)
        {
            return Observable.Zip(CryptoKeySecurityValue, identityReference, accessMask, isInherited, inheritanceFlags,
                ...
                (CryptoKeySecurityValueLambda, identityReferenceLambda, accessMaskLambda, isInheritedLambda,
                    inheritanceFlagsLambda, propagationFlagsLambda, typeLambda) =>
                    CryptoKeySecurityValueLambda.AccessRuleFactory(identityReferenceLambda, accessMaskLambda,
            ...
            IObservable<System.Security.AccessControl.AuditFlags> flags)
        {
            return Observable.Zip(CryptoKeySecurityValue, identityReference, accessMask, isInherited, inheritanceFlags,
                ...
                (CryptoKeySecurityValueLambda, identityReferenceLambda, accessMaskLambda, isInheritedLambda,
                    ...
                    CryptoKeySecurityValueLambda.AuditRuleFactory(identityReferenceLambda, accessMaskLambda,
        ...
        public static IObservable<System.Reactive.Unit> AddAccessRule(
            this IObservable<System.Security.AccessControl.CryptoKeySecurity> CryptoKeySecurityValue,
            IObservable<System.Security.AccessControl.CryptoKeyAccessRule> rule)
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) => CryptoKeySecurityValueLambda.AddAccessRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) => CryptoKeySecurityValueLambda.SetAccessRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) => CryptoKeySecurityValueLambda.ResetAccessRule(ruleLambda));
        }
        ...
        public static IObservable<System.Boolean> RemoveAccessRule(
            ...
            IObservable<System.Security.AccessControl.CryptoKeyAccessRule> rule)
        {
            return Observable.Zip(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) => CryptoKeySecurityValueLambda.RemoveAccessRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) =>
                    CryptoKeySecurityValueLambda.RemoveAccessRuleAll(ruleLambda));
        }
            ...
            IObservable<System.Security.AccessControl.CryptoKeyAccessRule> rule)
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) =>
                    CryptoKeySecurityValueLambda.RemoveAccessRuleSpecific(ruleLambda));
        }


        public static IObservable<System.Reactive.Unit> AddAuditRule(
            this IObservable<System.Security.AccessControl.CryptoKeySecurity> CryptoKeySecurityValue,
            IObservable<System.Security.AccessControl.CryptoKeyAuditRule> rule)
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) => CryptoKeySecurityValueLambda.AddAuditRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) => CryptoKeySecurityValueLambda.SetAuditRule(ruleLambda));
        }
        ...
        {
            return Observable.Zip(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) => CryptoKeySecurityValueLambda.RemoveAuditRule(ruleLambda));
        }
            ...
            IObservable<System.Security.AccessControl.CryptoKeyAuditRule> rule)
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) =>
                    CryptoKeySecurityValueLambda.RemoveAuditRuleAll(ruleLambda));
        }
            ...
            IObservable<System.Security.AccessControl.CryptoKeyAuditRule> rule)
        {
            return ObservableExt.ZipExecute(CryptoKeySecurityValue, rule,
                (CryptoKeySecurityValueLambda, ruleLambda) =>
                    CryptoKeySecurityValueLambda.RemoveAuditRuleSpecific(ruleLambda));
        }
        ...
        public static IObservable<System.Type> get_AccessRightType(
            this IObservable<System.Security.AccessControl.CryptoKeySecurity> CryptoKeySecurityValue)
        {
            return Observable.Select(CryptoKeySecurityValue,
                (CryptoKeySecurityValueLambda) => CryptoKeySecurityValueLambda.AccessRightType);
        }
        ...
        {
            return Observable.Select(CryptoKeySecurityValue,
                (CryptoKeySecurityValueLambda) => CryptoKeySecurityValueLambda.AccessRuleType);
        }
        ...
        {
            return Observable.Select(CryptoKeySecurityValue,
                (CryptoKeySecurityValueLambda) => CryptoKeySecurityValueLambda.AuditRuleType);
        }
    }
}