...
namespace System.Security.AccessControl
{
    public static class __MutexSecurity
    {
        public static IObservable<System.Security.AccessControl.AccessRule> AccessRuleFactory(
            this IObservable<System.Security.AccessControl.MutexSecurity> MutexSecurityValue,
            ...
            IObservable<System.Security.AccessControl.AccessControlType> type)
        {
            return Observable.Zip(MutexSecurityValue, identityReference, accessMask, isInherited, inheritanceFlags,
                ...
                (MutexSecurityValueLambda, identityReferenceLambda, accessMaskLambda, isInheritedLambda,
                    inheritanceFlagsLambda, propagationFlagsLambda, typeLambda) =>
                    MutexSecurityValueLambda.AccessRuleFactory(identityReferenceLambda, accessMaskLambda,
            ...
            IObservable<System.Security.AccessControl.AuditFlags> flags)
        {
            return Observable.Zip(MutexSecurityValue, identityReference, accessMask, isInherited, inheritanceFlags,
                ...
                (MutexSecurityValueLambda, identityReferenceLambda, accessMaskLambda, isInheritedLambda,
                    ...
                    MutexSecurityValueLambda.AuditRuleFactory(identityReferenceLambda, accessMaskLambda,
        ...
        public static IObservable<System.Reactive.Unit> AddAccessRule(
            this IObservable<System.Security.AccessControl.MutexSecurity> MutexSecurityValue,
            IObservable<System.Security.AccessControl.MutexAccessRule> rule)
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.AddAccessRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.SetAccessRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.ResetAccessRule(ruleLambda));
        }
        ...
        public static IObservable<System.Boolean> RemoveAccessRule(
            ...
            IObservable<System.Security.AccessControl.MutexAccessRule> rule)
        {
            return Observable.Zip(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.RemoveAccessRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.RemoveAccessRuleAll(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.RemoveAccessRuleSpecific(ruleLambda));
        }


        public static IObservable<System.Reactive.Unit> AddAuditRule(
            this IObservable<System.Security.AccessControl.MutexSecurity> MutexSecurityValue,
            IObservable<System.Security.AccessControl.MutexAuditRule> rule)
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.AddAuditRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.SetAuditRule(ruleLambda));
        }
        ...
        {
            return Observable.Zip(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.RemoveAuditRule(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.RemoveAuditRuleAll(ruleLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(MutexSecurityValue, rule,
                (MutexSecurityValueLambda, ruleLambda) => MutexSecurityValueLambda.RemoveAuditRuleSpecific(ruleLambda));
        }
        ...
        public static IObservable<System.Type> get_AccessRightType(
            this IObservable<System.Security.AccessControl.MutexSecurity> MutexSecurityValue)
        {
            return Observable.Select(MutexSecurityValue,
                (MutexSecurityValueLambda) => MutexSecurityValueLambda.AccessRightType);
        }
        ...
        {
            return Observable.Select(MutexSecurityValue,
                (MutexSecurityValueLambda) => MutexSecurityValueLambda.AccessRuleType);
        }
        ...
        {
            return Observable.Select(MutexSecurityValue,
                (MutexSecurityValueLambda) => MutexSecurityValueLambda.AuditRuleType);
        }
    }
}