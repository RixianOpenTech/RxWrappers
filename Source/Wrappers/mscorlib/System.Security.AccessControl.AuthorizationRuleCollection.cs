...
namespace System.Security.AccessControl
{
    public static class __AuthorizationRuleCollection
    {
        ...
        {
            return Observable.Zip(AuthorizationRuleCollectionValue, index, (AuthorizationRuleCollectionValueLambda, indexLambda) => AuthorizationRuleCollectionValueLambda[indexLambda]);
        }
