...
{
public static class _TransportHeaders
{
...
{
    return Observable.Zip(TransportHeadersValue, key, (TransportHeadersValueLambda, keyLambda) => TransportHeadersValueLambda.Item);
}
...
{
    return ObservableExt.ZipExecute(TransportHeadersValue, key, value, (TransportHeadersValueLambda, keyLambda, valueLambda) => TransportHeadersValueLambda.Item = valueLambda);
}
