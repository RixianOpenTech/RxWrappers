...
namespace System
{
    public static class __Int64
    {
        public static IObservable<System.Int32> CompareTo(this IObservable<System.Int64> Int64Value,
            IObservable<System.Object> value)
        {
            return Observable.Zip(Int64Value, value,
                (Int64ValueLambda, valueLambda) => Int64ValueLambda.CompareTo(valueLambda));
        }
        ...
        public static IObservable<System.Boolean> Equals(this IObservable<System.Int64> Int64Value,
        ...
        {
            return Observable.Zip(Int64Value, provider,
                (Int64ValueLambda, providerLambda) => Int64ValueLambda.ToString(providerLambda));
        }
        ...
        {
            return Observable.Zip(Int64Value, format,
                (Int64ValueLambda, formatLambda) => Int64ValueLambda.ToString(formatLambda));
        }
        ...
        {
            return Observable.Zip(Int64Value, format, provider,
                (Int64ValueLambda, formatLambda, providerLambda) =>
                    Int64ValueLambda.ToString(formatLambda, providerLambda));
        }
            ...
            IObservable<System.Globalization.NumberStyles> style, IObservable<System.IFormatProvider> provider)
        {
            return Observable.Zip(s, style, provider,
                (sLambda, styleLambda, providerLambda) => System.Int64.Parse(sLambda, styleLambda, providerLambda));
        }
