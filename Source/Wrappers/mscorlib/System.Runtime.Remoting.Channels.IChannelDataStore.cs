...
{
public static class _IChannelDataStore
{
...
{
    return Observable.Zip(IChannelDataStoreValue, key, (IChannelDataStoreValueLambda, keyLambda) => IChannelDataStoreValueLambda.Item);
}
...
{
    return ObservableExt.ZipExecute(IChannelDataStoreValue, key, value, (IChannelDataStoreValueLambda, keyLambda, valueLambda) => IChannelDataStoreValueLambda.Item = valueLambda);
}
