...
{
    public static class __SafeHandle
    {
        public static IObservable<System.IntPtr> DangerousGetHandle(
            this IObservable<System.Runtime.InteropServices.SafeHandle> SafeHandleValue)
        {
            return Observable.Select(SafeHandleValue,
                (SafeHandleValueLambda) => SafeHandleValueLambda.DangerousGetHandle());
        }
        ...
        {
            return
                Observable.Do(SafeHandleValue, (SafeHandleValueLambda) => SafeHandleValueLambda.SetHandleAsInvalid())
                    .ToUnit();
        }


        public static IObservable<System.Boolean> DangerousAddRef(
            this IObservable<System.Runtime.InteropServices.SafeHandle> SafeHandleValue,
            IObservable<System.Boolean> success)
        {
        ...
        public static IObservable<System.Reactive.Unit> DangerousRelease(
            this IObservable<System.Runtime.InteropServices.SafeHandle> SafeHandleValue)
        {
            return
                Observable.Do(SafeHandleValue, (SafeHandleValueLambda) => SafeHandleValueLambda.DangerousRelease())
                    .ToUnit();
        }
