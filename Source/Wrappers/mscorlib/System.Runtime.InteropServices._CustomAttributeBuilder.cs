...
{
    public static class ___CustomAttributeBuilder
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._CustomAttributeBuilder> _CustomAttributeBuilderValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_CustomAttributeBuilderValue, iTInfo, lcid, ppTInfo,
                (_CustomAttributeBuilderValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _CustomAttributeBuilderValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }
        ...
        {
            return Observable.Zip(_CustomAttributeBuilderValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_CustomAttributeBuilderValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                    rgDispIdLambda) =>
                {
                    _CustomAttributeBuilderValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda,
                        lcidLambda, rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_CustomAttributeBuilderValue, dispIdMember, riid, lcid, wFlags, pDispParams,
                pVarResult, pExcepInfo, puArgErr,
                (_CustomAttributeBuilderValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda,
                    pDispParamsLambda, pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _CustomAttributeBuilderValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda,
                        wFlagsLambda, pDispParamsLambda, pVarResultLambda, pExcepInfoLambda, puArgErrLambda);
                    return riidLambda;
                });
        }
    }
