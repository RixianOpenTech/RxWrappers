...
namespace System.Runtime.InteropServices
{
    public static class ___MethodRental
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._MethodRental> _MethodRentalValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_MethodRentalValue, iTInfo, lcid, ppTInfo,
                (_MethodRentalValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _MethodRentalValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }
        ...
        {
            return Observable.Zip(_MethodRentalValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_MethodRentalValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda) =>
                {
                    _MethodRentalValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                        rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_MethodRentalValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,
                pExcepInfo, puArgErr,
                (_MethodRentalValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda, pDispParamsLambda,
                    pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _MethodRentalValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
