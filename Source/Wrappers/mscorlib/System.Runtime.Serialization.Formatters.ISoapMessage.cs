...
{
    public static class __ISoapMessage
    {
        public static IObservable<System.String[]> get_ParamNames(
            this IObservable<System.Runtime.Serialization.Formatters.ISoapMessage> ISoapMessageValue)
        {
        ...
        public static IObservable<System.String> get_XmlNameSpace(
            this IObservable<System.Runtime.Serialization.Formatters.ISoapMessage> ISoapMessageValue)
        {
            return Observable.Select(ISoapMessageValue,
                (ISoapMessageValueLambda) => ISoapMessageValueLambda.XmlNameSpace);
        }
        ...
        {
            return ObservableExt.ZipExecute(ISoapMessageValue, value,
                (ISoapMessageValueLambda, valueLambda) => ISoapMessageValueLambda.ParamNames = valueLambda);
        }
        ...
        {
            return ObservableExt.ZipExecute(ISoapMessageValue, value,
                (ISoapMessageValueLambda, valueLambda) => ISoapMessageValueLambda.ParamValues = valueLambda);
        }
        ...
        {
            return ObservableExt.ZipExecute(ISoapMessageValue, value,
                (ISoapMessageValueLambda, valueLambda) => ISoapMessageValueLambda.ParamTypes = valueLambda);
        }
        ...
        {
            return ObservableExt.ZipExecute(ISoapMessageValue, value,
                (ISoapMessageValueLambda, valueLambda) => ISoapMessageValueLambda.MethodName = valueLambda);
        }
        ...
        {
            return ObservableExt.ZipExecute(ISoapMessageValue, value,
                (ISoapMessageValueLambda, valueLambda) => ISoapMessageValueLambda.XmlNameSpace = valueLambda);
        }
        ...
        {
            return ObservableExt.ZipExecute(ISoapMessageValue, value,
                (ISoapMessageValueLambda, valueLambda) => ISoapMessageValueLambda.Headers = valueLambda);
        }
    }
}