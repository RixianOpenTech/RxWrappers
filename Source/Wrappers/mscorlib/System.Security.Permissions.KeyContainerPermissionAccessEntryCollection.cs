...
namespace System.Security.Permissions
{
    public static class __KeyContainerPermissionAccessEntryCollection
    {
        ...
        {
            return Observable.Zip(KeyContainerPermissionAccessEntryCollectionValue, index, (KeyContainerPermissionAccessEntryCollectionValueLambda, indexLambda) => KeyContainerPermissionAccessEntryCollectionValueLambda[indexLambda]);
        }
