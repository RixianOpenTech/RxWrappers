...
{
    public static class __ITypeInfo
    {
        public static IObservable<System.IntPtr> GetTypeAttr(
            this IObservable<System.Runtime.InteropServices.ComTypes.ITypeInfo> ITypeInfoValue)
        {
        ...
        {
            return Observable.Zip(ITypeInfoValue, memid, rgBstrNames, cMaxNames,
                (ITypeInfoValueLambda, memidLambda, rgBstrNamesLambda, cMaxNamesLambda) =>
                {
        ...
        {
            return ObservableExt.ZipExecute(ITypeInfoValue, rgszNames, cNames, pMemId,
                (ITypeInfoValueLambda, rgszNamesLambda, cNamesLambda, pMemIdLambda) =>
                    ITypeInfoValueLambda.GetIDsOfNames(rgszNamesLambda, cNamesLambda, pMemIdLambda));
        }
        ...
        {
            return Observable.Zip(ITypeInfoValue, pvInstance, memid, wFlags, pDispParams, pVarResult, pExcepInfo,
                (ITypeInfoValueLambda, pvInstanceLambda, memidLambda, wFlagsLambda, pDispParamsLambda, pVarResultLambda,
                    pExcepInfoLambda) =>
                {
                    System.Int32 puArgErrOutput = default(System.Int32);
                    ITypeInfoValueLambda.Invoke(pvInstanceLambda, memidLambda, wFlagsLambda, ref pDispParamsLambda,
            ...
            IObservable<System.Int32> index)
        {
            return Observable.Zip(ITypeInfoValue, index, (ITypeInfoValueLambda, indexLambda) =>
            {
                ...
                ITypeInfoValueLambda.GetDocumentation(indexLambda, out strNameOutput, out strDocStringOutput,
        ...
        {
            return ObservableExt.ZipExecute(ITypeInfoValue, memid, invKind, pBstrDllName, pBstrName, pwOrdinal,
                (ITypeInfoValueLambda, memidLambda, invKindLambda, pBstrDllNameLambda, pBstrNameLambda, pwOrdinalLambda)
                    =>
                    ITypeInfoValueLambda.GetDllEntry(memidLambda, invKindLambda, pBstrDllNameLambda, pBstrNameLambda,
                        pwOrdinalLambda));
        }
        ...
        {
            return Observable.Zip(ITypeInfoValue, pUnkOuter, riid,
                (ITypeInfoValueLambda, pUnkOuterLambda, riidLambda) =>
                {
        ...
        public static IObservable<Tuple<System.Runtime.InteropServices.ComTypes.ITypeLib, System.Int32>>
            GetContainingTypeLib(this IObservable<System.Runtime.InteropServices.ComTypes.ITypeInfo> ITypeInfoValue)
        {
            return Observable.Select(ITypeInfoValue, (ITypeInfoValueLambda) =>
            {
        ...
        {
            return ObservableExt.ZipExecute(ITypeInfoValue, pTypeAttr,
                (ITypeInfoValueLambda, pTypeAttrLambda) => ITypeInfoValueLambda.ReleaseTypeAttr(pTypeAttrLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(ITypeInfoValue, pFuncDesc,
                (ITypeInfoValueLambda, pFuncDescLambda) => ITypeInfoValueLambda.ReleaseFuncDesc(pFuncDescLambda));
        }
        ...
        {
            return ObservableExt.ZipExecute(ITypeInfoValue, pVarDesc,
                (ITypeInfoValueLambda, pVarDescLambda) => ITypeInfoValueLambda.ReleaseVarDesc(pVarDescLambda));
        }
    }
}