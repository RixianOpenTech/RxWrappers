...
return ppVarDescOutput;
        ...
        public static IObservable<int> GetNames(this IObservable<System.Runtime.InteropServices.ComTypes.ITypeInfo> ITypeInfoValue, IObservable<System.Int32> memid, IObservable<System.String[]> rgBstrNames, IObservable<System.Int32> cMaxNames)
        {
...
return pImplTypeFlagsOutput;
        ...
        public static IObservable<Unit> GetIDsOfNames(this IObservable<System.Runtime.InteropServices.ComTypes.ITypeInfo> ITypeInfoValue, IObservable<System.String[]> rgszNames, IObservable<System.Int32> cNames, IObservable<System.Int32[]> pMemId)
        {
            return ObservableExt.ZipExecute(ITypeInfoValue, rgszNames, cNames, pMemId, (ITypeInfoValueLambda, rgszNamesLambda, cNamesLambda, pMemIdLambda) => ITypeInfoValueLambda.GetIDsOfNames(rgszNamesLambda, cNamesLambda, pMemIdLambda));
        }
