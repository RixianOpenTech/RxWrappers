...
{
    public static class __TaskFactory1
    {
        public static IObservable<TResult> StartNew<TResult>(
            this IObservable<System.Threading.Tasks.TaskFactory<TResult>> TaskFactoryValue,
            IObservable<Func<TResult>> function)
        {
            return
        ...
        public static IObservable<TResult> StartNew<TResult>(
            this IObservable<System.Threading.Tasks.TaskFactory<TResult>> TaskFactoryValue,
            IObservable<Func<TResult>> function, IObservable<System.Threading.CancellationToken> cancellationToken)
        {
            return
        ...
        public static IObservable<TResult> StartNew<TResult>(
            this IObservable<System.Threading.Tasks.TaskFactory<TResult>> TaskFactoryValue,
            IObservable<Func<TResult>> function, IObservable<System.Threading.Tasks.TaskCreationOptions> creationOptions)
        {
            return
        ...
        public static IObservable<System.Threading.CancellationToken> get_CancellationToken<TResult>(
            this IObservable<System.Threading.Tasks.TaskFactory<TResult>> TaskFactoryValue)
        {
        ...
        public static IObservable<System.Threading.Tasks.TaskScheduler> get_Scheduler<TResult>(
            this IObservable<System.Threading.Tasks.TaskFactory<TResult>> TaskFactoryValue)
        {
        ...
        public static IObservable<System.Threading.Tasks.TaskCreationOptions> get_CreationOptions<TResult>(
            this IObservable<System.Threading.Tasks.TaskFactory<TResult>> TaskFactoryValue)
        {
            return Observable.Select(TaskFactoryValue,
        ...
        public static IObservable<System.Threading.Tasks.TaskContinuationOptions> get_ContinuationOptions<TResult>(
            this IObservable<System.Threading.Tasks.TaskFactory<TResult>> TaskFactoryValue)
        {
            return Observable.Select(TaskFactoryValue,
