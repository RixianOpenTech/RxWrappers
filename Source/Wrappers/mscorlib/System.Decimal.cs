...
public static IObservable<System.Boolean> Equals(IObservable<System.Decimal> d1, IObservable<System.Decimal> d2)
{
    return Observable.Zip(d1, d2, (d1Lambda, d2Lambda) => System.Decimal.Equals(d1Lambda, d2Lambda));
}
