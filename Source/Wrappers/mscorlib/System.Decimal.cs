...
namespace System
{
    public static class __Decimal
    {
        ...
        public static IObservable<System.Int32> CompareTo(this IObservable<System.Decimal> DecimalValue,
            IObservable<System.Object> value)
        {
            return Observable.Zip(DecimalValue, value,
                (DecimalValueLambda, valueLambda) => DecimalValueLambda.CompareTo(valueLambda));
        }
        ...
        public static IObservable<System.Boolean> Equals(this IObservable<System.Decimal> DecimalValue,
            IObservable<System.Object> value)
        {
            return Observable.Zip(DecimalValue, value,
                (DecimalValueLambda, valueLambda) => DecimalValueLambda.Equals(valueLambda));
        }
        ...
        {
            return Observable.Zip(DecimalValue, format,
                (DecimalValueLambda, formatLambda) => DecimalValueLambda.ToString(formatLambda));
        }
        ...
        {
            return Observable.Zip(DecimalValue, provider,
                (DecimalValueLambda, providerLambda) => DecimalValueLambda.ToString(providerLambda));
        }
        ...
        {
            return Observable.Zip(DecimalValue, format, provider,
                (DecimalValueLambda, formatLambda, providerLambda) =>
                    DecimalValueLambda.ToString(formatLambda, providerLambda));
        }
            ...
            IObservable<System.IFormatProvider> provider)
        {
            return Observable.Zip(s, provider,
                (sLambda, providerLambda) => System.Decimal.Parse(sLambda, providerLambda));
        }
            ...
            IObservable<System.Globalization.NumberStyles> style, IObservable<System.IFormatProvider> provider)
        {
            return Observable.Zip(s, style, provider,
                (sLambda, styleLambda, providerLambda) => System.Decimal.Parse(sLambda, styleLambda, providerLambda));
        }
        ...
        public static IObservable<System.Decimal> Remainder(IObservable<System.Decimal> d1,
            IObservable<System.Decimal> d2)
        {
            return Observable.Zip(d1, d2, (d1Lambda, d2Lambda) => System.Decimal.Remainder(d1Lambda, d2Lambda));
        }


        public static IObservable<System.Decimal> Multiply(IObservable<System.Decimal> d1,
            IObservable<System.Decimal> d2)
        {
        ...
        {
            return Observable.Zip(d, decimals,
                (dLambda, decimalsLambda) => System.Decimal.Round(dLambda, decimalsLambda));
        }
            ...
            IObservable<System.Int32> decimals, IObservable<System.MidpointRounding> mode)
        {
            return Observable.Zip(d, decimals, mode,
                (dLambda, decimalsLambda, modeLambda) => System.Decimal.Round(dLambda, decimalsLambda, modeLambda));
        }


        public static IObservable<System.Decimal> Subtract(IObservable<System.Decimal> d1,
            IObservable<System.Decimal> d2)
        {
