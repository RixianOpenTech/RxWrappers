...
namespace System.Collections.ObjectModel
{
    public static class __Collection1
    {
        ...
        {
            return Observable.Zip(CollectionValue, index, (CollectionValueLambda, indexLambda) => CollectionValueLambda[indexLambda]);
        }
        ...
        {
            return ObservableExt.ZipExecute(CollectionValue, index, value, (CollectionValueLambda, indexLambda, valueLambda) => CollectionValueLambda[indexLambda] = valueLambda);
        }
