...
namespace System
{
public static class _Tuple3
{
    
public static IObservable<System.Boolean> Equals<T1, T2, T3>(this IObservable<System.Tuple<T1, T2, T3>> TupleValue, IObservable<System.Object> obj)
{
    return Observable.Zip(TupleValue, obj, (TupleValueLambda, objLambda) => TupleValueLambda.Equals(objLambda));
}


public static IObservable<System.Int32> GetHashCode<T1, T2, T3>(this IObservable<System.Tuple<T1, T2, T3>> TupleValue)
{
    return Observable.Select(TupleValue, (TupleValueLambda) => TupleValueLambda.GetHashCode());
}


public static IObservable<System.String> ToString<T1, T2, T3>(this IObservable<System.Tuple<T1, T2, T3>> TupleValue)
{
