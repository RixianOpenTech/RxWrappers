...
{
public static class _UCOMIStream
{
    
public static IObservable<System.Byte> Read(this IObservable<System.Runtime.InteropServices.UCOMIStream> UCOMIStreamValue, IObservable<System.Byte[]> pv, IObservable<System.Int32> cb, IObservable<System.IntPtr> pcbRead)
{
    return Observable.Zip(UCOMIStreamValue, pv, cb, pcbRead, (UCOMIStreamValueLambda, pvLambda, cbLambda, pcbReadLambda) => UCOMIStreamValueLambda.Read(pvLambda, cbLambda, pcbReadLambda));
}
