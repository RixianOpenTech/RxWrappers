...
namespace System.Runtime.InteropServices
{
    public static class ___AssemblyName
    {
        public static IObservable<System.UInt32> GetTypeInfoCount(
            this IObservable<System.Runtime.InteropServices._AssemblyName> _AssemblyNameValue)
        {
        ...
        {
            return ObservableExt.ZipExecute(_AssemblyNameValue, iTInfo, lcid, ppTInfo,
                (_AssemblyNameValueLambda, iTInfoLambda, lcidLambda, ppTInfoLambda) =>
                    _AssemblyNameValueLambda.GetTypeInfo(iTInfoLambda, lcidLambda, ppTInfoLambda));
        }
        ...
        {
            return Observable.Zip(_AssemblyNameValue, riid, rgszNames, cNames, lcid, rgDispId,
                (_AssemblyNameValueLambda, riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda, rgDispIdLambda) =>
                {
                    _AssemblyNameValueLambda.GetIDsOfNames(ref riidLambda, rgszNamesLambda, cNamesLambda, lcidLambda,
                        rgDispIdLambda);
                    return riidLambda;
                });
        }
        ...
        {
            return Observable.Zip(_AssemblyNameValue, dispIdMember, riid, lcid, wFlags, pDispParams, pVarResult,
                pExcepInfo, puArgErr,
                (_AssemblyNameValueLambda, dispIdMemberLambda, riidLambda, lcidLambda, wFlagsLambda, pDispParamsLambda,
                    pVarResultLambda, pExcepInfoLambda, puArgErrLambda) =>
                {
                    _AssemblyNameValueLambda.Invoke(dispIdMemberLambda, ref riidLambda, lcidLambda, wFlagsLambda,
